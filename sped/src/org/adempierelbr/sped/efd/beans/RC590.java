 ...
 * DE FORNECIMENTO D'ÁGUA CANALIZADA (CÓDIGO 29) E NOTA FISCAL CONSUMO FORNECIMENTO DE GÁS (CÓDIGO 28).
 * @author Mario Grigioni, mgrigioni
 * @version $Id: RC590.java, 10/02/2011, 15:23:00, mgrigioni
 */
public class RC590 extends RegSped implements Comparable<Object> {
	 ...
	 * @param DT_DOC
	 */
	public RC590 (String CST_ICMS, String CFOP, BigDecimal ALIQ_ICMS, BigDecimal VL_OPR,
			BigDecimal VL_BC_ICMS, BigDecimal VL_ICMS, BigDecimal VL_BC_ICMS_ST, 
			BigDecimal VL_ICMS_ST, BigDecimal VL_RED_BC, String COD_OBS, String NUM_DOC, Timestamp DT_DOC)
	{	
		super();
	...
	public void addValues(RC590 otherC590){
		this.VL_OPR        = getVL_OPR().add(otherC590.getVL_OPR());
		this.VL_BC_ICMS    = getVL_BC_ICMS().add(otherC590.getVL_BC_ICMS());
		this.VL_ICMS       = getVL_ICMS().add(otherC590.getVL_ICMS());
		this.VL_BC_ICMS_ST = getVL_BC_ICMS_ST().add(otherC590.getVL_BC_ICMS_ST());
		this.VL_ICMS_ST    = getVL_ICMS_ST().add(otherC590.getVL_ICMS_ST());
		this.VL_RED_BC     = getVL_RED_BC().add(otherC590.getVL_RED_BC());
	}
	...
	/**
	 * Formata o Bloco C Registro 590
	 * 
	 * @return
	 */
