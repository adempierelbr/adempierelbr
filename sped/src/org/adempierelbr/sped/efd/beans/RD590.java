 ...
 * @version $Id: RD590.java, 11/02/2011, 09:48:00, mgrigioni
 */
public class RD590 extends RegSped implements Comparable<Object> {
	...
	public void addValues(RD590 otherD590){
		this.VL_OPR        = getVL_OPR().add(otherD590.getVL_OPR());
		this.VL_BC_ICMS    = getVL_BC_ICMS().add(otherD590.getVL_BC_ICMS());
		this.VL_ICMS       = getVL_ICMS().add(otherD590.getVL_ICMS());
		this.VL_BC_ICMS_ST = getVL_BC_ICMS_ST().add(otherD590.getVL_BC_ICMS_ST());
		this.VL_ICMS_ST    = getVL_ICMS_ST().add(otherD590.getVL_ICMS_ST());
	...
	/**
	 * Formata o Bloco D Registro 590
	 * 
	 * @return
	 */
