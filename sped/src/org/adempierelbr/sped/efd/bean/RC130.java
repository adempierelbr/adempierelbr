...
public class RC130 extends RegSped {
	...
	public String toString() {
		...
		StringBuilder format = new StringBuilder(PIPE).append(REG).append(PIPE)
				.append(VL_SERV_NT).append(PIPE).append(VL_BC_ISSQN)
				.append(PIPE).append(VL_ISSQN).append(PIPE).append(VL_BC_IRRF)
				.append(PIPE).append(VL_IRRF).append(PIPE).append(VL_BC_PREV)
				.append(PIPE).append(VL_PREV).append(PIPE);
