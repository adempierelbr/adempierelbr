...
public class RA170 extends RegSped implements Comparable<Object>{
	...
	public String toString() {
		...
		StringBuilder format = new StringBuilder
            ...
            .append(PIPE).append(TextUtil.checkSize(IND_ORIG_CRED, 1))
            .append(PIPE).append(TextUtil.checkSize(CST_PIS,2))
            .append(PIPE).append(TextUtil.toNumeric(VL_BC_PIS,2))
            .append(PIPE).append(TextUtil.toNumeric(ALIQ_PIS,2))
            ...
            .append(PIPE).append(TextUtil.toNumeric(ALIQ_COFINS,2))
            .append(PIPE).append(TextUtil.toNumeric(VL_COFINS,2))
            .append(PIPE).append(TextUtil.checkSize(COD_CTA, 60))
            .append(PIPE).append(TextUtil.checkSize(COD_CCUS, 60))
            .append(PIPE);
