...
// 'N'
	...
	/** Set BP Delivery Country Code.
		@param LBR_BPDeliveryCountryCode 
		BP Delivery Country - Copied from the BP Location into Brazilan Legal and Tax Books
	  */
	public void setLBR_BPDeliveryCountryCode (String LBR_BPDeliveryCountryCode)
	{
		set_Value (COLUMNNAME_LBR_BPDeliveryCountryCode, LBR_BPDeliveryCountryCode);
	}

	/** Get BP Delivery Country Code.
		@return BP Delivery Country - Copied from the BP Location into Brazilan Legal and Tax Books
	  */
	public String getLBR_BPDeliveryCountryCode () 
	{
		return (String)get_Value(COLUMNNAME_LBR_BPDeliveryCountryCode);
	}
