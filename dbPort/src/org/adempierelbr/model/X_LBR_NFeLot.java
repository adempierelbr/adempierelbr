...
// N
	...
	public static final String LBR_NFEANSWERSTATUS_201_RejeiçãoONumeroMáximoDeNumeraçãoDeNF_EAInutil = "201";
	/** 202-Rejeição: Falha no reconhecimento da autoria ou integri = 202 */
	public static final String LBR_NFEANSWERSTATUS_202_RejeiçãoFalhaNoReconhecimentoDaAutoriaOuIntegri = "202";
	/** 203-Rejeição: Emissor não habilitado para emissão de NFC-e = 203 */
	public static final String LBR_NFEANSWERSTATUS_203_RejeiçãoEmissorNãoHabilitadoParaEmissãoDeNFC_E = "203";
	/** 204-Rejeição: Duplicidade de NF-e [999999999999999999999999 = 204 */
	public static final String LBR_NFEANSWERSTATUS_204_RejeiçãoDuplicidadeDeNF_E999999999999999999999999 = "204";
	/** 205-Rejeição: NF-e está denegada na base de dados da SEFAZ = 205 */
	public static final String LBR_NFEANSWERSTATUS_205_RejeiçãoNF_EEstáDenegadaNaBaseDeDadosDaSEFAZ = "205";
	/** 206-Rejeição: NFC-e já está inutilizada na Base de Dados da = 206 */
	public static final String LBR_NFEANSWERSTATUS_206_RejeiçãoNFC_EJáEstáInutilizadaNaBaseDeDadosDa = "206";
	...
	public static final String LBR_NFEANSWERSTATUS_212_RejeiçãoDataDeEmissãoNFC_EPosteriorADataDeRec = "212";
	/** 213-Rejeição: CNPJ-Base do Autor difere do CNPJ-Base do Cer = 213 */
	public static final String LBR_NFEANSWERSTATUS_213_RejeiçãoCNPJ_BaseDoAutorDifereDoCNPJ_BaseDoCer = "213";
	/** 214-Rejeição: Tamanho da mensagem excedeu o limite estabele = 214 */
	public static final String LBR_NFEANSWERSTATUS_214_RejeiçãoTamanhoDaMensagemExcedeuOLimiteEstabele = "214";
	/** 215-Rejeição: Falha Schema XML = 215 */
	public static final String LBR_NFEANSWERSTATUS_215_RejeiçãoFalhaSchemaXML = "215";
	...
	public static final String LBR_NFEANSWERSTATUS_218_RejeiçãoNF_EJáEstaCanceladaNaBaseDeDadosDaSE = "218";
	...
	public static final String LBR_NFEANSWERSTATUS_220_RejeiçãoPrazoDeCancelamentoSuperiorAoPrevistoNa = "220";
	/** 221-Rejeição: Confirmado o recebimento da NF-e pelo destina = 221 */
	public static final String LBR_NFEANSWERSTATUS_221_RejeiçãoConfirmadoORecebimentoDaNF_EPeloDestina = "221";
	/** 222-Rejeição: Protocolo de Autorização de Uso difere do cad = 222 */
	public static final String LBR_NFEANSWERSTATUS_222_RejeiçãoProtocoloDeAutorizaçãoDeUsoDifereDoCad = "222";
	/** 223-Rejeição: CNPJ do transmissor do lote difere do CNPJ do = 223 */
	public static final String LBR_NFEANSWERSTATUS_223_RejeiçãoCNPJDoTransmissorDoLoteDifereDoCNPJDo = "223";
	...
	public static final String LBR_NFEANSWERSTATUS_226_RejeiçãoCódigoDaUFDoEmitenteDivergeDaUFAutori = "226";
	/** 227-Rejeição: Erro na Chave de Acesso - Campo Id – falta a  = 227 */
	public static final String LBR_NFEANSWERSTATUS_227_RejeiçãoErroNaChaveDeAcesso_CampoIdFaltaA = "227";
	...
	public static final String LBR_NFEANSWERSTATUS_236_RejeiçãoChaveDeAcessoComDígitoVerificadorInváli = "236";
	...
	public static final String LBR_NFEANSWERSTATUS_238_RejeiçãoCabeçalho_VersãoDoArquivoXMLSuperiorA = "238";
	/** 239-Rejeição: Cabeçalho - Versão do arquivo XML não suporta = 239 */
	public static final String LBR_NFEANSWERSTATUS_239_RejeiçãoCabeçalho_VersãoDoArquivoXMLNãoSuporta = "239";
	/** 240-Rejeição: Cancelamento/Inutilização - Irregularidade Fi = 240 */
	public static final String LBR_NFEANSWERSTATUS_240_RejeiçãoCancelamentoInutilização_IrregularidadeFi = "240";
	...
	public static final String LBR_NFEANSWERSTATUS_242_RejeiçãoElementoNfeCabecMsgInexistenteNoSOAPHead = "242";
	...
	public static final String LBR_NFEANSWERSTATUS_244_RejeiçãoCNPJDoCertificadoDigitalDifereDoCNPJDa = "244";
	...
	public static final String LBR_NFEANSWERSTATUS_247_RejeiçãoSiglaDaUFDoEmitenteDivergeDaUFAutoriz = "247";
	...
	public static final String LBR_NFEANSWERSTATUS_249_RejeiçãoUFDaChaveDeAcessoDivergeDaUFAutorizad = "249";
	...
	public static final String LBR_NFEANSWERSTATUS_251_RejeiçãoUFMunicípioDestinatárioNãoPertenceASUFR = "251";
	/** 252-Rejeição: Ambiente informado diverge do Ambiente de rec = 252 */
	public static final String LBR_NFEANSWERSTATUS_252_RejeiçãoAmbienteInformadoDivergeDoAmbienteDeRec = "252";
	/** 253-Rejeição: Digito Verificador da chave de acesso compost = 253 */
	public static final String LBR_NFEANSWERSTATUS_253_RejeiçãoDigitoVerificadorDaChaveDeAcessoCompost = "253";
	...
	public static final String LBR_NFEANSWERSTATUS_255_RejeiçãoNF_EComplementarPossuiMaisDeUmaNFRefer = "255";
	/** 256-Rejeição: Uma NF-e da faixa já está inutilizada na Base = 256 */
	public static final String LBR_NFEANSWERSTATUS_256_RejeiçãoUmaNF_EDaFaixaJáEstáInutilizadaNaBase = "256";
	/** 257-Rejeição: Solicitante não habilitado para emissão da NF = 257 */
	public static final String LBR_NFEANSWERSTATUS_257_RejeiçãoSolicitanteNãoHabilitadoParaEmissãoDaNF = "257";
	...
	public static final String LBR_NFEANSWERSTATUS_259_RejeiçãoCNPJDaConsultaNãoCadastradoComoContribu = "259";
	...
	public static final String LBR_NFEANSWERSTATUS_261_RejeiçãoIEDaConsultaNãoCadastradaComoContribuin = "261";
	...
	public static final String LBR_NFEANSWERSTATUS_264_RejeiçãoCPFDaConsultaNãoCadastradoComoContribui = "264";
	/** 265-Rejeição: Sigla da UF da consulta difere da UF do Web S = 265 */
	public static final String LBR_NFEANSWERSTATUS_265_RejeiçãoSiglaDaUFDaConsultaDifereDaUFDoWebS = "265";
	...
	public static final String LBR_NFEANSWERSTATUS_267_RejeiçãoChaveDeAcessoReferenciadaInexistente = "267";
	/** 268-Rejeição: NF Complementar referencia uma outra NF-e Com = 268 */
	public static final String LBR_NFEANSWERSTATUS_268_RejeiçãoNFComplementarReferenciaUmaOutraNF_ECom = "268";
	/** 269-Rejeição: CNPJ Emitente da NF Complementar difere do CN = 269 */
	public static final String LBR_NFEANSWERSTATUS_269_RejeiçãoCNPJEmitenteDaNFComplementarDifereDoCN = "269";
	/** 270-Rejeição: Código Município do Fato Gerador: dígito invá = 270 */
	public static final String LBR_NFEANSWERSTATUS_270_RejeiçãoCódigoMunicípioDoFatoGeradorDígitoInvá = "270";
	/** 271-Rejeição: Código Município do Fato Gerador: difere da U = 271 */
	public static final String LBR_NFEANSWERSTATUS_271_RejeiçãoCódigoMunicípioDoFatoGeradorDifereDaU = "271";
	/** 272-Rejeição: Código Município do Emitente: dígito inválido = 272 */
	public static final String LBR_NFEANSWERSTATUS_272_RejeiçãoCódigoMunicípioDoEmitenteDígitoInválido = "272";
	/** 273-Rejeição: Código Município do Emitente: difere da UF do = 273 */
	public static final String LBR_NFEANSWERSTATUS_273_RejeiçãoCódigoMunicípioDoEmitenteDifereDaUFDo = "273";
	/** 274-Rejeição: Código Município do Destinatário: dígito invá = 274 */
	public static final String LBR_NFEANSWERSTATUS_274_RejeiçãoCódigoMunicípioDoDestinatárioDígitoInvá = "274";
	/** 275-Rejeição: Código Município do Destinatário: difere da U = 275 */
	public static final String LBR_NFEANSWERSTATUS_275_RejeiçãoCódigoMunicípioDoDestinatárioDifereDaU = "275";
	/** 276-Rejeição: Código Município do Local de Retirada: dígito = 276 */
	public static final String LBR_NFEANSWERSTATUS_276_RejeiçãoCódigoMunicípioDoLocalDeRetiradaDígito = "276";
	/** 277-Rejeição: Código Município do Local de Retirada: difere = 277 */
	public static final String LBR_NFEANSWERSTATUS_277_RejeiçãoCódigoMunicípioDoLocalDeRetiradaDifere = "277";
	/** 278-Rejeição: Código Município do Local de Entrega: dígito  = 278 */
	public static final String LBR_NFEANSWERSTATUS_278_RejeiçãoCódigoMunicípioDoLocalDeEntregaDígito = "278";
	/** 279-Rejeição: Código Município do Local de Entrega: difere  = 279 */
	public static final String LBR_NFEANSWERSTATUS_279_RejeiçãoCódigoMunicípioDoLocalDeEntregaDifere = "279";
	...
	public static final String LBR_NFEANSWERSTATUS_283_RejeiçãoCertificadoTransmissor_ErroCadeiaDeCert = "283";
	...
	public static final String LBR_NFEANSWERSTATUS_287_RejeiçãoCódigoMunicípioDoFG_ISSQNDígitoInváli = "287";
	/** 288-Rejeição: Código Município do FG - Transporte: dígito i = 288 */
	public static final String LBR_NFEANSWERSTATUS_288_RejeiçãoCódigoMunicípioDoFG_TransporteDígitoI = "288";
	/** 289-Rejeição: Código da UF informada diverge da UF solicita = 289 */
	public static final String LBR_NFEANSWERSTATUS_289_RejeiçãoCódigoDaUFInformadaDivergeDaUFSolicita = "289";
	...
	public static final String LBR_NFEANSWERSTATUS_293_RejeiçãoCertificadoAssinatura_ErroCadeiaDeCerti = "293";
	...
	public static final String LBR_NFEANSWERSTATUS_298_RejeiçãoAssinaturaDifereDoPadrãoDoProjeto = "298";
	/** 299-Rejeição: XML da área de cabeçalho com codificação dife = 299 */
	public static final String LBR_NFEANSWERSTATUS_299_RejeiçãoXMLDaÁreaDeCabeçalhoComCodificaçãoDife = "299";
	/** 401-Rejeição: CPF do remetente inválido = 401 */
	public static final String LBR_NFEANSWERSTATUS_401_RejeiçãoCPFDoRemetenteInválido = "401";
	/** 402-Rejeição: XML da área de dados com codificação diferent = 402 */
	public static final String LBR_NFEANSWERSTATUS_402_RejeiçãoXMLDaÁreaDeDadosComCodificaçãoDiferent = "402";
	/** 403-Rejeição: O grupo de informações da NF-e avulsa é de us = 403 */
	public static final String LBR_NFEANSWERSTATUS_403_RejeiçãoOGrupoDeInformaçõesDaNF_EAvulsaÉDeUs = "403";
	...
	public static final String LBR_NFEANSWERSTATUS_406_RejeiçãoCódigoDoPaísDoDestinatárioDígitoInváli = "406";
	/** 407-Rejeição: O CPF só pode ser informado no campo emitente = 407 */
	public static final String LBR_NFEANSWERSTATUS_407_RejeiçãoOCPFSóPodeSerInformadoNoCampoEmitente = "407";
	/** 453-Rejeição: Ano de inutilização não pode ser superior ao  = 453 */
	public static final String LBR_NFEANSWERSTATUS_453_RejeiçãoAnoDeInutilizaçãoNãoPodeSerSuperiorAo = "453";
	/** 454-Rejeição: Ano de inutilização não pode ser inferior a 2 = 454 */
	public static final String LBR_NFEANSWERSTATUS_454_RejeiçãoAnoDeInutilizaçãoNãoPodeSerInferiorA2 = "454";
	/** 478-Rejeição: Local da entrega não informado para faturamen = 478 */
	public static final String LBR_NFEANSWERSTATUS_478_RejeiçãoLocalDaEntregaNãoInformadoParaFaturamen = "478";
	/** 999-Rejeição: Erro não catalogado = 999 */
	public static final String LBR_NFEANSWERSTATUS_999_RejeiçãoErroNãoCatalogado = "999";
	/** 301-Rejeição: Irregularidade Cadastral do Emitente = 301 */
	public static final String LBR_NFEANSWERSTATUS_301_RejeiçãoIrregularidadeCadastralDoEmitente = "301";
	...
	public static final String LBR_NFEANSWERSTATUS_409_RejeiçãoCampoCUFInexistenteNoElementoNfeCabecMsg = "409";
	/** 410-Rejeição: UF informada no campo cUF não é atendida pelo = 410 */
	public static final String LBR_NFEANSWERSTATUS_410_RejeiçãoUFInformadaNoCampoCUFNãoÉAtendidaPelo = "410";
	/** 411-Rejeição: Campo versaoDados inexistente no elemento nfe = 411 */
	public static final String LBR_NFEANSWERSTATUS_411_RejeiçãoCampoVersaoDadosInexistenteNoElementoNfe = "411";
	...
	public static final String LBR_NFEANSWERSTATUS_452_RejeiçãoTipoAutorizadorDoReciboDivergeDoÓrgãoA = "452";
	/** 502-Rejeição: Erro na Chave de Acesso - Campo Id não corres = 502 */
	public static final String LBR_NFEANSWERSTATUS_502_RejeiçãoErroNaChaveDeAcesso_CampoIdNãoCorres = "502";
	/** 503-Rejeição: Série utilizada fora da faixa permitida no SC = 503 */
	public static final String LBR_NFEANSWERSTATUS_503_RejeiçãoSérieUtilizadaForaDaFaixaPermitidaNoSC = "503";
	...
	public static final String LBR_NFEANSWERSTATUS_507_RejeiçãoOCNPJDoDestinatárioRemetenteNãoDeveSer = "507";
	/** 508-Rejeição: O CNPJ com conteúdo nulo só é válido em opera = 508 */
	public static final String LBR_NFEANSWERSTATUS_508_RejeiçãoOCNPJComConteúdoNuloSóÉVálidoEmOpera = "508";
	/** 509-Rejeição: O CNPJ com conteúdo nulo só é válido em opera = 509 */
	public static final String LBR_NFEANSWERSTATUS_509_RejeiçãoOCNPJComConteúdoNuloSóÉVálidoEmOpera = "509";
	/** 510-Rejeição: Operação com Exterior e Código País destinatá = 510 */
	public static final String LBR_NFEANSWERSTATUS_510_RejeiçãoOperaçãoComExteriorECódigoPaísDestinatá = "510";
	/** 511-Rejeição: Não é de Operação com Exterior e Código País  = 511 */
	public static final String LBR_NFEANSWERSTATUS_511_RejeiçãoNãoÉDeOperaçãoComExteriorECódigoPaís = "511";
	...
	public static final String LBR_NFEANSWERSTATUS_513_RejeiçãoCódigoMunicípioDoLocalDeRetiradaDeveSe = "513";
	...
	public static final String LBR_NFEANSWERSTATUS_515_RejeiçãoCódigoMunicípioDoLocalDeEntregaDeveSer = "515";
	/** 516-Rejeição: Falha Schema XML, inexiste a tag raiz esperad = 516 */
	public static final String LBR_NFEANSWERSTATUS_516_RejeiçãoFalhaSchemaXMLInexisteATagRaizEsperad = "516";
	/** 517-Rejeição: Falha Schema XML, inexiste atributo versão na = 517 */
	public static final String LBR_NFEANSWERSTATUS_517_RejeiçãoFalhaSchemaXMLInexisteAtributoVersãoNa = "517";
	...
	public static final String LBR_NFEANSWERSTATUS_520_RejeiçãoCFOPDeOperaçãoComExteriorEUFDestinatár = "520";
	/** 521-Rejeição: CFOP de Operação Estadual e UF do emitente di = 521 */
	public static final String LBR_NFEANSWERSTATUS_521_RejeiçãoCFOPDeOperaçãoEstadualEUFDoEmitenteDi = "521";
	/** 522-Rejeição: CFOP de Operação Estadual e UF emitente difer = 522 */
	public static final String LBR_NFEANSWERSTATUS_522_RejeiçãoCFOPDeOperaçãoEstadualEUFEmitenteDifer = "522";
	/** 523-Rejeição: CFOP não é de Operação Estadual e UF emitente = 523 */
	public static final String LBR_NFEANSWERSTATUS_523_RejeiçãoCFOPNãoÉDeOperaçãoEstadualEUFEmitente = "523";
	/** 524-Rejeição: CFOP de Operação com Exterior e não informado = 524 */
	public static final String LBR_NFEANSWERSTATUS_524_RejeiçãoCFOPDeOperaçãoComExteriorENãoInformado = "524";
	/** 525-Rejeição: CFOP de Importação e não informado dados da D = 525 */
	public static final String LBR_NFEANSWERSTATUS_525_RejeiçãoCFOPDeImportaçãoENãoInformadoDadosDaD = "525";
	/** 526-Rejeição: CFOP de Exportação e não informado Local de E = 526 */
	public static final String LBR_NFEANSWERSTATUS_526_RejeiçãoCFOPDeExportaçãoENãoInformadoLocalDeE = "526";
	/** 527-Rejeição: Operação de Exportação com informação de ICMS = 527 */
	public static final String LBR_NFEANSWERSTATUS_527_RejeiçãoOperaçãoDeExportaçãoComInformaçãoDeICMS = "527";
	...
	public static final String LBR_NFEANSWERSTATUS_529_RejeiçãoNCMDeInformaçãoObrigatóriaParaProdutoTr = "529";
	/** 530-Rejeição: Operação com tributação de ISSQN sem informar = 530 */
	public static final String LBR_NFEANSWERSTATUS_530_RejeiçãoOperaçãoComTributaçãoDeISSQNSemInformar = "530";
	/** 531-Rejeição: Total da BC ICMS difere do somatório dos iten = 531 */
	public static final String LBR_NFEANSWERSTATUS_531_RejeiçãoTotalDaBCICMSDifereDoSomatórioDosIten = "531";
	...
	public static final String LBR_NFEANSWERSTATUS_533_RejeiçãoTotalDaBCICMS_STDifereDoSomatórioDosI = "533";
	/** 534-Rejeição: Total do ICMS-ST difere do somatório dos iten = 534 */
	public static final String LBR_NFEANSWERSTATUS_534_RejeiçãoTotalDoICMS_STDifereDoSomatórioDosIten = "534";
	...
	public static final String LBR_NFEANSWERSTATUS_537_RejeiçãoTotalDoDescontoDifereDoSomatórioDosIte = "537";
	...
	public static final String LBR_NFEANSWERSTATUS_539_RejeiçãoDuplicidadeDeNFC_EComDiferençaNaChaveD = "539";
	...
	public static final String LBR_NFEANSWERSTATUS_545_RejeiçãoFalhaNoSchemaXMLVersãoInformadaNaVer = "545";
	/** 546-Rejeição: Erro na Chave de Acesso – Campo Id – falta a  = 546 */
	public static final String LBR_NFEANSWERSTATUS_546_RejeiçãoErroNaChaveDeAcessoCampoIdFaltaA = "546";
	/** 547-Rejeição: Dígito Verificador da Chave de Acesso da NF-e = 547 */
	public static final String LBR_NFEANSWERSTATUS_547_RejeiçãoDígitoVerificadorDaChaveDeAcessoDaNF_E = "547";
	...
	public static final String LBR_NFEANSWERSTATUS_552_RejeiçãoDígitoVerificadorDaChaveDeAcessoDoCT_E = "552";
	/** 553-Rejeição: Tipo autorizador do recibo diverge do Órgão A = 553 */
	public static final String LBR_NFEANSWERSTATUS_553_RejeiçãoTipoAutorizadorDoReciboDivergeDoÓrgãoA = "553";
	...
	public static final String LBR_NFEANSWERSTATUS_555_RejeiçãoTipoAutorizadorDoProtocoloDivergeDoÓrgã = "555";
	/** 556-Rejeição: Justificativa de entrada em contingência não  = 556 */
	public static final String LBR_NFEANSWERSTATUS_556_RejeiçãoJustificativaDeEntradaEmContingênciaNão = "556";
	/** 557-Rejeição: A Justificativa de entrada em contingência de = 557 */
	public static final String LBR_NFEANSWERSTATUS_557_RejeiçãoAJustificativaDeEntradaEmContingênciaDe = "557";
	/** 558-Rejeição: Data de entrada em contingência posterior a d = 558 */
	public static final String LBR_NFEANSWERSTATUS_558_RejeiçãoDataDeEntradaEmContingênciaPosteriorAD = "558";
	/** 559-Rejeição: UF do Transportador não informado = 559 */
	public static final String LBR_NFEANSWERSTATUS_559_RejeiçãoUFDoTransportadorNãoInformado = "559";
	/** 560-Rejeição: CNPJ base do emitente difere do CNPJ base da  = 560 */
	public static final String LBR_NFEANSWERSTATUS_560_RejeiçãoCNPJBaseDoEmitenteDifereDoCNPJBaseDa = "560";
	/** 561-Rejeição: Mês de Emissão informado na Chave de Acesso d = 561 */
	public static final String LBR_NFEANSWERSTATUS_561_RejeiçãoMêsDeEmissãoInformadoNaChaveDeAcessoD = "561";
	/** 562-Rejeição: Código numérico informado na Chave de Acesso  = 562 */
	public static final String LBR_NFEANSWERSTATUS_562_RejeiçãoCódigoNuméricoInformadoNaChaveDeAcesso = "562";
	/** 563-Rejeição: Já existe pedido de Inutilização com a mesma  = 563 */
	public static final String LBR_NFEANSWERSTATUS_563_RejeiçãoJáExistePedidoDeInutilizaçãoComAMesma = "563";
	/** 564-Rejeição: Total do Produto / Serviço difere do somatóri = 564 */
	public static final String LBR_NFEANSWERSTATUS_564_RejeiçãoTotalDoProdutoServiçoDifereDoSomatóri = "564";
	/** 565-Rejeição: Falha no schema XML – inexiste a tag raiz esp = 565 */
	public static final String LBR_NFEANSWERSTATUS_565_RejeiçãoFalhaNoSchemaXMLInexisteATagRaizEsp = "565";
	/** 567-Rejeição: Falha no schema XML – versão informada na ver = 567 */
	public static final String LBR_NFEANSWERSTATUS_567_RejeiçãoFalhaNoSchemaXMLVersãoInformadaNaVer = "567";
	/** 568-Rejeição: Falha no schema XML – inexiste atributo versa = 568 */
	public static final String LBR_NFEANSWERSTATUS_568_RejeiçãoFalhaNoSchemaXMLInexisteAtributoVersa = "568";
	/** 569-Rejeição: Data de entrada em contingência muito atrasad = 569 */
	public static final String LBR_NFEANSWERSTATUS_569_RejeiçãoDataDeEntradaEmContingênciaMuitoAtrasad = "569";
	/** 570-Rejeição: Tipo de emissão 3, 6 e 7 só é valido nas cont = 570 */
	public static final String LBR_NFEANSWERSTATUS_570_RejeiçãoTipoDeEmissão36E7SóÉValidoNasCont = "570";
	/** 571-Rejeição:  O tpEmis informado diferente de 3 para conti = 571 */
	public static final String LBR_NFEANSWERSTATUS_571_RejeiçãoOTpEmisInformadoDiferenteDe3ParaConti = "571";
	...
	public static final String LBR_NFEANSWERSTATUS_135_EventoRegistradoEVinculadoANFC_E = "135";
	/** 136-Evento registrado, mas não vinculado a NFC-e = 136 */
	public static final String LBR_NFEANSWERSTATUS_136_EventoRegistradoMasNãoVinculadoANFC_E = "136";
	...
	public static final String LBR_NFEANSWERSTATUS_501_RejeiçãoPrazoDeCancelamentoSuperiorAoPrevistoNa = "501";
	/** 572-Rejeição: Erro Atributo ID do evento não corresponde a  = 572 */
	public static final String LBR_NFEANSWERSTATUS_572_RejeiçãoErroAtributoIDDoEventoNãoCorrespondeA = "572";
	...
	public static final String LBR_NFEANSWERSTATUS_574_RejeiçãoOAutorDoEventoDivergeDoEmissorDaNFC_E = "574";
	/** 575-Rejeição: O autor do evento diverge do destinatário da  = 575 */
	public static final String LBR_NFEANSWERSTATUS_575_RejeiçãoOAutorDoEventoDivergeDoDestinatárioDa = "575";
	/** 576-Rejeição: O autor do evento não é um órgão autorizado a = 576 */
	public static final String LBR_NFEANSWERSTATUS_576_RejeiçãoOAutorDoEventoNãoÉUmÓrgãoAutorizadoA = "576";
	/** 577-Rejeição: A data do evento não pode ser menor que a dat = 577 */
	public static final String LBR_NFEANSWERSTATUS_577_RejeiçãoADataDoEventoNãoPodeSerMenorQueADat = "577";
	/** 578-Rejeição: A data do evento não pode ser maior que a dat = 578 */
	public static final String LBR_NFEANSWERSTATUS_578_RejeiçãoADataDoEventoNãoPodeSerMaiorQueADat = "578";
	/** 579-Rejeição: A data do evento não pode ser menor que a dat = 579 */
	public static final String LBR_NFEANSWERSTATUS_579_RejeiçãoADataDoEventoNãoPodeSerMenorQueADat = "579";
	...
	public static final String LBR_NFEANSWERSTATUS_587_RejeiçãoUsarSomenteONamespacePadrãoDaNFC_E = "587";
	/** 588-Rejeição: Não é permitida a presença de caracteres de e = 588 */
	public static final String LBR_NFEANSWERSTATUS_588_RejeiçãoNãoÉPermitidaAPresençaDeCaracteresDeE = "588";
	/** 590-Rejeição: Informado CST para emissor do Simples Naciona = 590 */
	public static final String LBR_NFEANSWERSTATUS_590_RejeiçãoInformadoCSTParaEmissorDoSimplesNaciona = "590";
	/** 591-Rejeição: Informado CSOSN para emissor que não é do Sim = 591 */
	public static final String LBR_NFEANSWERSTATUS_591_RejeiçãoInformadoCSOSNParaEmissorQueNãoÉDoSim = "591";
	/** 592-Rejeição: A NF-e deve ter pelo menos um item de produto = 592 */
	public static final String LBR_NFEANSWERSTATUS_592_RejeiçãoANF_EDeveTerPeloMenosUmItemDeProduto = "592";
	/** 595-Rejeição: A versão do leiaute da NF-e utilizada não é m = 595 */
	public static final String LBR_NFEANSWERSTATUS_595_RejeiçãoAVersãoDoLeiauteDaNF_EUtilizadaNãoÉM = "595";
	/** 596-Rejeição: Ambiente de homologação indisponível para rec = 596 */
	public static final String LBR_NFEANSWERSTATUS_596_RejeiçãoAmbienteDeHomologaçãoIndisponívelParaRec = "596";
	/** 597-Rejeição: CFOP de Importação e não informado dados de I = 597 */
	public static final String LBR_NFEANSWERSTATUS_597_RejeiçãoCFOPDeImportaçãoENãoInformadoDadosDeI = "597";
	/** 598-Rejeição: NF-e emitida em ambiente de homologação com r = 598 */
	public static final String LBR_NFEANSWERSTATUS_598_RejeiçãoNF_EEmitidaEmAmbienteDeHomologaçãoComR = "598";
	/** 599-Rejeição: CFOP de Importação e não informado dados de I = 599 */
	public static final String LBR_NFEANSWERSTATUS_599_RejeiçãoCFOPDeImportaçãoENãoInformadoDadosDeI = "599";
	...
	public static final String LBR_NFEANSWERSTATUS_594_RejeiçãoONúmeroDeSequenciaDoEventoInformadoÉM = "594";
	...
	public static final String LBR_NFEANSWERSTATUS_602_RejeiçãoTotalDoPISDifereDoSomatórioDosItensSu = "602";
	/** 603-Rejeição: Total do COFINS difere do somatório dos itens = 603 */
	public static final String LBR_NFEANSWERSTATUS_603_RejeiçãoTotalDoCOFINSDifereDoSomatórioDosItens = "603";
	...
	public static final String LBR_NFEANSWERSTATUS_605_RejeiçãoTotalDoVServDifereDoSomatórioDoVProdD = "605";
	/** 606-Rejeição: Total do vBC do ISS difere do somatório dos i = 606 */
	public static final String LBR_NFEANSWERSTATUS_606_RejeiçãoTotalDoVBCDoISSDifereDoSomatórioDosI = "606";
	...
	public static final String LBR_NFEANSWERSTATUS_608_RejeiçãoTotalDoPISDifereDoSomatórioDosItensSu = "608";
	/** 609-Rejeição: Total do COFINS difere do somatório dos itens = 609 */
	public static final String LBR_NFEANSWERSTATUS_609_RejeiçãoTotalDoCOFINSDifereDoSomatórioDosItens = "609";
	/** 610-Rejeição: Total da NF difere do somatório dos Valores c = 610 */
	public static final String LBR_NFEANSWERSTATUS_610_RejeiçãoTotalDaNFDifereDoSomatórioDosValoresC = "610";
	...
	public static final String LBR_NFEANSWERSTATUS_613_RejeiçãoChaveDeAcessoDifereDaExistenteEmBD99 = "613";
	...
	public static final String LBR_NFEANSWERSTATUS_615_RejeiçãoChaveDeAcessoInválidaAnoMenorQue06Ou = "615";
	/** 616-Rejeição: Chave de Acesso inválida (Mês menor que 1 ou  = 616 */
	public static final String LBR_NFEANSWERSTATUS_616_RejeiçãoChaveDeAcessoInválidaMêsMenorQue1Ou = "616";
	/** 617-Rejeição: Chave de Acesso inválida (CNPJ zerado ou dígi = 617 */
	public static final String LBR_NFEANSWERSTATUS_617_RejeiçãoChaveDeAcessoInválidaCNPJZeradoOuDígi = "617";
	/** 618-Rejeição: Chave de Acesso inválida (modelo diferente de = 618 */
	public static final String LBR_NFEANSWERSTATUS_618_RejeiçãoChaveDeAcessoInválidaModeloDiferenteDe = "618";
	...
	public static final String LBR_NFEANSWERSTATUS_625_RejeiçãoInscriçãoSUFRAMADeveSerInformadaNaVenda = "625";
	/** 626-Rejeição: CFOP de operação isenta para ZFM diferente do = 626 */
	public static final String LBR_NFEANSWERSTATUS_626_RejeiçãoCFOPDeOperaçãoIsentaParaZFMDiferenteDo = "626";
	...
	public static final String LBR_NFEANSWERSTATUS_628_RejeiçãoTotalDaNFSuperiorAoValorLimiteEstabele = "628";
	/** 629-Rejeição: Valor do Produto difere do produto Valor Unit = 629 */
	public static final String LBR_NFEANSWERSTATUS_629_RejeiçãoValorDoProdutoDifereDoProdutoValorUnit = "629";
	/** 630-Rejeição: Valor do Produto difere do produto Valor Unit = 630 */
	public static final String LBR_NFEANSWERSTATUS_630_RejeiçãoValorDoProdutoDifereDoProdutoValorUnit = "630";
	/** 635-Rejeição: NF-e com mesmo número e série já transmitida  = 635 */
	public static final String LBR_NFEANSWERSTATUS_635_RejeiçãoNF_EComMesmoNúmeroESérieJáTransmitida = "635";
	/** 642-Rejeição: Falha na Consulta do Registro de Passagem, te = 642 */
	public static final String LBR_NFEANSWERSTATUS_642_RejeiçãoFalhaNaConsultaDoRegistroDePassagemTe = "642";
	/** 137-Nenhum documento localizado = 137 */
	public static final String LBR_NFEANSWERSTATUS_137_NenhumDocumentoLocalizado = "137";
	/** 138-Documento localizado = 138 */
	public static final String LBR_NFEANSWERSTATUS_138_DocumentoLocalizado = "138";
	...
	public static final String LBR_NFEANSWERSTATUS_589_RejeiçãoNúmeroDoNSUInformadoSuperiorAoMaiorNSU = "589";
	/** 593-Rejeição: CNPJ-Base consultado difere do CNPJ-Base do C = 593 */
	public static final String LBR_NFEANSWERSTATUS_593_RejeiçãoCNPJ_BaseConsultadoDifereDoCNPJ_BaseDoC = "593";
	/** 631-Rejeição: CNPJ-Base do Destinatário difere do CNPJ-Base = 631 */
	public static final String LBR_NFEANSWERSTATUS_631_RejeiçãoCNPJ_BaseDoDestinatárioDifereDoCNPJ_Base = "631";
	/** 632-Rejeição: Solicitação fora de prazo, a NF-e não está ma = 632 */
	public static final String LBR_NFEANSWERSTATUS_632_RejeiçãoSolicitaçãoForaDePrazoANF_ENãoEstáMa = "632";
	/** 633-Rejeição: NF-e indisponível para download devido a ausê = 633 */
	public static final String LBR_NFEANSWERSTATUS_633_RejeiçãoNF_EIndisponívelParaDownloadDevidoAAusê = "633";
	/** 634-Rejeição: Destinatário da NF-e não tem o mesmo CNPJ rai = 634 */
	public static final String LBR_NFEANSWERSTATUS_634_RejeiçãoDestinatárioDaNF_ENãoTemOMesmoCNPJRai = "634";
	/** 640-Rejeição: Evento de "Ciência da Operação" não pode ser  = 640 */
	public static final String LBR_NFEANSWERSTATUS_640_RejeiçãoEventoDeCiênciaDaOperaçãoNãoPodeSer = "640";
	/** 641-Rejeição: Consumo Indevido 645 = 641 */
	public static final String LBR_NFEANSWERSTATUS_641_RejeiçãoConsumoIndevido645 = "641";
	/** 645-Rejeição: CNPJ do Certificado Digital não é emitente de = 645 */
	public static final String LBR_NFEANSWERSTATUS_645_RejeiçãoCNPJDoCertificadoDigitalNãoÉEmitenteDe = "645";
	/** 646-Rejeição: NF-e Cancelada, arquivo indisponível para dow = 646 */
	public static final String LBR_NFEANSWERSTATUS_646_RejeiçãoNF_ECanceladaArquivoIndisponívelParaDow = "646";
	/** 647-Rejeição: NF-e Denegada, arquivo indisponível para down = 647 */
	public static final String LBR_NFEANSWERSTATUS_647_RejeiçãoNF_EDenegadaArquivoIndisponívelParaDown = "647";
	/** 650-Rejeição: Evento de "Ciência da Operação" para NF-e Can = 650 */
	public static final String LBR_NFEANSWERSTATUS_650_RejeiçãoEventoDeCiênciaDaOperaçãoParaNF_ECan = "650";
	/** 651-Rejeição: Evento de "Desconhecimento da Operação" para  = 651 */
	public static final String LBR_NFEANSWERSTATUS_651_RejeiçãoEventoDeDesconhecimentoDaOperaçãoPara = "651";
	/** 653-Rejeição: NF-e Cancelada, arquivo indisponível para dow = 653 */
	public static final String LBR_NFEANSWERSTATUS_653_RejeiçãoNF_ECanceladaArquivoIndisponívelParaDow = "653";
	/** 654-Rejeição: NF-e Denegada, arquivo indisponível para down = 654 */
	public static final String LBR_NFEANSWERSTATUS_654_RejeiçãoNF_EDenegadaArquivoIndisponívelParaDown = "654";
	/** 655-Rejeição: Evento de Ciência da Operação informado após  = 655 */
	public static final String LBR_NFEANSWERSTATUS_655_RejeiçãoEventoDeCiênciaDaOperaçãoInformadoApós = "655";
	...
	public static final String LBR_NFEANSWERSTATUS_658_RejeiçãoUFDoDestinatárioDaChaveDeAcessoDiverge = "658";
	/** 150-Consulta de CSC realizada com sucesso, com CSC ativo(s) = 150 */
	public static final String LBR_NFEANSWERSTATUS_150_ConsultaDeCSCRealizadaComSucessoComCSCAtivoS = "150";
	/** 151-Consulta de CSC realizada com sucesso, sem CSC ativo = 151 */
	public static final String LBR_NFEANSWERSTATUS_151_ConsultaDeCSCRealizadaComSucessoSemCSCAtivo = "151";
	/** 479-Rejeição: Emissor em situação irregular perante o fisco = 479 */
	public static final String LBR_NFEANSWERSTATUS_479_RejeiçãoEmissorEmSituaçãoIrregularPeranteOFisco = "479";
	/** 480-Rejeição: CNPJ da Chave de acesso da NF-e informada div = 480 */
	public static final String LBR_NFEANSWERSTATUS_480_RejeiçãoCNPJDaChaveDeAcessoDaNF_EInformadaDiv = "480";
	/** 481-Rejeição: UF da Chave de acesso diverge do código da UF = 481 */
	public static final String LBR_NFEANSWERSTATUS_481_RejeiçãoUFDaChaveDeAcessoDivergeDoCódigoDaUF = "481";
	/** 482-Rejeição: AA da Chave de acesso inválida = 482 */
	public static final String LBR_NFEANSWERSTATUS_482_RejeiçãoAADaChaveDeAcessoInválida = "482";
	/** 483-Rejeição: MM da chave de acesso inválido = 483 */
	public static final String LBR_NFEANSWERSTATUS_483_RejeiçãoMMDaChaveDeAcessoInválido = "483";
	/** 484-Rejeição: Chave de Acesso com tipo de emissão diferente = 484 */
	public static final String LBR_NFEANSWERSTATUS_484_RejeiçãoChaveDeAcessoComTipoDeEmissãoDiferente = "484";
	/** 485-Rejeição: Duplicidade de numeração do EPEC (Modelo, CNP = 485 */
	public static final String LBR_NFEANSWERSTATUS_485_RejeiçãoDuplicidadeDeNumeraçãoDoEPECModeloCNP = "485";
	/** 486-Rejeição: DPEC não localizada para o número de registro = 486 */
	public static final String LBR_NFEANSWERSTATUS_486_RejeiçãoDPECNãoLocalizadaParaONúmeroDeRegistro = "486";
	/** 487-Rejeição: Nenhuma DPEC localizada para a chave de acess = 487 */
	public static final String LBR_NFEANSWERSTATUS_487_RejeiçãoNenhumaDPECLocalizadaParaAChaveDeAcess = "487";
	/** 488-Rejeição: Requisitante de Consulta não tem o mesmo CNPJ = 488 */
	public static final String LBR_NFEANSWERSTATUS_488_RejeiçãoRequisitanteDeConsultaNãoTemOMesmoCNPJ = "488";
	/** 660-Rejeição: CFOP de Combustível e não informado grupo de  = 660 */
	public static final String LBR_NFEANSWERSTATUS_660_RejeiçãoCFOPDeCombustívelENãoInformadoGrupoDe = "660";
	/** 661-Rejeição: NFC-e já existente para o número do EPEC info = 661 */
	public static final String LBR_NFEANSWERSTATUS_661_RejeiçãoNFC_EJáExistenteParaONúmeroDoEPECInfo = "661";
	/** 662-Rejeição: Numeração do EPEC está inutilizada na Base de = 662 */
	public static final String LBR_NFEANSWERSTATUS_662_RejeiçãoNumeraçãoDoEPECEstáInutilizadaNaBaseDe = "662";
	/** 678-Rejeição: NF referenciada com UF diferente da UF da NF- = 678 */
	public static final String LBR_NFEANSWERSTATUS_678_RejeiçãoNFReferenciadaComUFDiferenteDaUFDaNF_ = "678";
	/** 679-Rejeição: Modelo da NF-e referenciada diferente de 55 = 679 */
	public static final String LBR_NFEANSWERSTATUS_679_RejeiçãoModeloDaNF_EReferenciadaDiferenteDe55 = "679";
	/** 680-Rejeição: Duplicidade de NF-e referenciada (Chave de Ac = 680 */
	public static final String LBR_NFEANSWERSTATUS_680_RejeiçãoDuplicidadeDeNF_EReferenciadaChaveDeAc = "680";
	/** 681-Rejeição: Duplicidade de NF Modelo 1 referenciada (CNPJ = 681 */
	public static final String LBR_NFEANSWERSTATUS_681_RejeiçãoDuplicidadeDeNFModelo1ReferenciadaCNPJ = "681";
	/** 682-Rejeição: Duplicidade de NF de Produtor referenciada (I = 682 */
	public static final String LBR_NFEANSWERSTATUS_682_RejeiçãoDuplicidadeDeNFDeProdutorReferenciadaI = "682";
	...
	public static final String LBR_NFEANSWERSTATUS_684_RejeiçãoDuplicidadeDeCupomFiscalReferenciadoMod = "684";
	/** 685-Rejeição: Total do Valor Aproximado dos Tributos difere = 685 */
	public static final String LBR_NFEANSWERSTATUS_685_RejeiçãoTotalDoValorAproximadoDosTributosDifere = "685";
	...
	public static final String LBR_NFEANSWERSTATUS_688_RejeiçãoNFReferenciadaDeProdutorComIEInexistent = "688";
	/** 689-Rejeição: NF referenciada de Produtor com IE não vincul = 689 */
	public static final String LBR_NFEANSWERSTATUS_689_RejeiçãoNFReferenciadaDeProdutorComIENãoVincul = "689";
	/** 690-Rejeição: Pedido de Cancelamento para NF-e com CT-e ou  = 690 */
	public static final String LBR_NFEANSWERSTATUS_690_RejeiçãoPedidoDeCancelamentoParaNF_EComCT_EOu = "690";
	/** 304-Rejeição: Pedido de Cancelamento para NF-e com evento d = 304 */
	public static final String LBR_NFEANSWERSTATUS_304_RejeiçãoPedidoDeCancelamentoParaNF_EComEventoD = "304";
	/** 152-CSC gerado = 152 */
	public static final String LBR_NFEANSWERSTATUS_152_CSCGerado = "152";
	/** 153-CSC revogado = 153 */
	public static final String LBR_NFEANSWERSTATUS_153_CSCRevogado = "153";
	/** 802-Rejeição: Contribuinte possui número máximo de CSC ativ = 802 */
	public static final String LBR_NFEANSWERSTATUS_802_RejeiçãoContribuintePossuiNúmeroMáximoDeCSCAtiv = "802";
	/** 803-Rejeição: O CSC e o identificador informado não possuem = 803 */
	public static final String LBR_NFEANSWERSTATUS_803_RejeiçãoOCSCEOIdentificadorInformadoNãoPossuem = "803";
	/** 804-Rejeição: O CSC informado não pertence ao solicitante d = 804 */
	public static final String LBR_NFEANSWERSTATUS_804_RejeiçãoOCSCInformadoNãoPertenceAoSolicitanteD = "804";
	/** 805-Rejeição: O CSC informado está revogado = 805 */
	public static final String LBR_NFEANSWERSTATUS_805_RejeiçãoOCSCInformadoEstáRevogado = "805";
	/** 695-Rejeição: Solicitante não autorizado para a consulta = 695 */
	public static final String LBR_NFEANSWERSTATUS_695_RejeiçãoSolicitanteNãoAutorizadoParaAConsulta = "695";
	...
	public static final String LBR_NFEANSWERSTATUS_473_RejeiçãoCertificadoTransmissorSemCNPJOuCPF = "473";
	/** 719-Rejeição: NFC-e com valor total superior ao permitido p = 719 */
	public static final String LBR_NFEANSWERSTATUS_719_RejeiçãoNFC_EComValorTotalSuperiorAoPermitidoP = "719";
	/** 408-Rejeição: Evento não disponível para Autor pessoa físic = 408 */
	public static final String LBR_NFEANSWERSTATUS_408_RejeiçãoEventoNãoDisponívelParaAutorPessoaFísic = "408";
	/** 417-Rejeição: Total do ICMS superior ao valor limite estabe = 417 */
	public static final String LBR_NFEANSWERSTATUS_417_RejeiçãoTotalDoICMSSuperiorAoValorLimiteEstabe = "417";
	/** 418-Rejeição: Total do ICMS ST superior ao valor limite est = 418 */
	public static final String LBR_NFEANSWERSTATUS_418_RejeiçãoTotalDoICMSSTSuperiorAoValorLimiteEst = "418";
	/** 455-Rejeição: Órgão Autor do evento diferente da UF da Chav = 455 */
	public static final String LBR_NFEANSWERSTATUS_455_RejeiçãoÓrgãoAutorDoEventoDiferenteDaUFDaChav = "455";
	...
	public static final String LBR_NFEANSWERSTATUS_467_RejeiçãoDadosDaNFC_EDivergentesDoEPEC = "467";
	/** 468-Rejeição: NFC-e com Tipo Emissão = 4, sem EPEC correspo = 468 */
	public static final String LBR_NFEANSWERSTATUS_468_RejeiçãoNFC_EComTipoEmissãoEq4SemEPECCorrespo = "468";
	/** 659-Rejeição: Ano-Mês da Data de Emissão diverge do Ano-Mês = 659 */
	public static final String LBR_NFEANSWERSTATUS_659_RejeiçãoAno_MêsDaDataDeEmissãoDivergeDoAno_Mês = "659";
	/** 720-Rejeição: Na operação com Exterior deve ser informada t = 720 */
	public static final String LBR_NFEANSWERSTATUS_720_RejeiçãoNaOperaçãoComExteriorDeveSerInformadaT = "720";
	/** 721-Rejeição: Operação interestadual não deve informar idEs = 721 */
	public static final String LBR_NFEANSWERSTATUS_721_RejeiçãoOperaçãoInterestadualNãoDeveInformarIdEs = "721";
	/** 792-Rejeição: Informada a IE do destinatário para operação  = 792 */
	public static final String LBR_NFEANSWERSTATUS_792_RejeiçãoInformadaAIEDoDestinatárioParaOperação = "792";
	/** 472-Rejeição: CPF consultado difere do CPF do Certificado D = 472 */
	public static final String LBR_NFEANSWERSTATUS_472_RejeiçãoCPFConsultadoDifereDoCPFDoCertificadoD = "472";
	...
	public static final String LBR_NFEANSWERSTATUS_155_CancelamentoDeNF_EHomologadoForaDePrazo = "155";
	/** 303-Uso Denegado : Destinatário não habilitado a operar na  = 303 */
	public static final String LBR_NFEANSWERSTATUS_303_UsoDenegadoDestinatárioNãoHabilitadoAOperarNa = "303";
	/** 321-Rejeição: NF-e de devolução não possui conhecimento fis = 321 */
	public static final String LBR_NFEANSWERSTATUS_321_RejeiçãoNF_EDeDevoluçãoNãoPossuiConhecimentoFis = "321";
	/** 322-Rejeição: NF-e de devolução com mais de um documento fi = 322 */
	public static final String LBR_NFEANSWERSTATUS_322_RejeiçãoNF_EDeDevoluçãoComMaisDeUmDocumentoFi = "322";
	...
	public static final String LBR_NFEANSWERSTATUS_324_RejeiçãoCNPJDoDestinatárioJaAutorizadoParaDownl = "324";
	...
	public static final String LBR_NFEANSWERSTATUS_326_RejeiçãoCPFDoDestinatárioAutorizadoParaDownload = "326";
	/** 327-Rejeição: CFOP inválido para NF-e com finalidade de dev = 327 */
	public static final String LBR_NFEANSWERSTATUS_327_RejeiçãoCFOPInválidoParaNF_EComFinalidadeDeDev = "327";
	/** 328-Rejeição: CFOP inválido para NF-e que não tem finalidad = 328 */
	public static final String LBR_NFEANSWERSTATUS_328_RejeiçãoCFOPInválidoParaNF_EQueNãoTemFinalidad = "328";
	...
	public static final String LBR_NFEANSWERSTATUS_330_RejeiçãoInformarOValorDaAFRMMNaImportaçãoPorV = "330";
	/** 331-Rejeição: Informar o CNPJ do adquirente ou do encomenda = 331 */
	public static final String LBR_NFEANSWERSTATUS_331_RejeiçãoInformarOCNPJDoAdquirenteOuDoEncomenda = "331";
	/** 332-Rejeição: CNPJ do adquirente ou do encomendante da impo = 332 */
	public static final String LBR_NFEANSWERSTATUS_332_RejeiçãoCNPJDoAdquirenteOuDoEncomendanteDaImpo = "332";
	/** 333-Rejeição: Informar a UF do adquirente ou do encomendant = 333 */
	public static final String LBR_NFEANSWERSTATUS_333_RejeiçãoInformarAUFDoAdquirenteOuDoEncomendant = "333";
	/** 334-Rejeição: Número do processo de drawback não informado  = 334 */
	public static final String LBR_NFEANSWERSTATUS_334_RejeiçãoNúmeroDoProcessoDeDrawbackNãoInformado = "334";
	/** 335-Rejeição: Número do processo de drawback na importação  = 335 */
	public static final String LBR_NFEANSWERSTATUS_335_RejeiçãoNúmeroDoProcessoDeDrawbackNaImportação = "335";
	/** 336-Rejeição: Informado o grupo de exportação no item para  = 336 */
	public static final String LBR_NFEANSWERSTATUS_336_RejeiçãoInformadoOGrupoDeExportaçãoNoItemPara = "336";
	/** 337-Rejeição: Não informado o grupo de exportação no item = 337 */
	public static final String LBR_NFEANSWERSTATUS_337_RejeiçãoNãoInformadoOGrupoDeExportaçãoNoItem = "337";
	/** 338-Rejeição: Número de processo de drawback não informado  = 338 */
	public static final String LBR_NFEANSWERSTATUS_338_RejeiçãoNúmeroDeProcessoDeDrawbackNãoInformado = "338";
	/** 339-Rejeição: Número de processo de drawback na exportação  = 339 */
	public static final String LBR_NFEANSWERSTATUS_339_RejeiçãoNúmeroDeProcessoDeDrawbackNaExportação = "339";
	/** 340-Rejeição: Não informado o grupo de exportação indireta  = 340 */
	public static final String LBR_NFEANSWERSTATUS_340_RejeiçãoNãoInformadoOGrupoDeExportaçãoIndireta = "340";
	...
	public static final String LBR_NFEANSWERSTATUS_342_RejeiçãoChaveDeAcessoInformadaNaExportaçãoIndir = "342";
	/** 343-Rejeição: Modelo da NF-e informada na exportação indire = 343 */
	public static final String LBR_NFEANSWERSTATUS_343_RejeiçãoModeloDaNF_EInformadaNaExportaçãoIndire = "343";
	/** 344-Rejeição: Duplicidade de NF-e informada na exportação i = 344 */
	public static final String LBR_NFEANSWERSTATUS_344_RejeiçãoDuplicidadeDeNF_EInformadaNaExportaçãoI = "344";
	/** 345-Rejeição: Chave de acesso informada na exportação indir = 345 */
	public static final String LBR_NFEANSWERSTATUS_345_RejeiçãoChaveDeAcessoInformadaNaExportaçãoIndir = "345";
	/** 346-Rejeição: Somatório quantidades informadas na exportaçã = 346 */
	public static final String LBR_NFEANSWERSTATUS_346_RejeiçãoSomatórioQuantidadesInformadasNaExportaçã = "346";
	/** 347-Rejeição: Descrição do combustível diverge da descrição = 347 */
	public static final String LBR_NFEANSWERSTATUS_347_RejeiçãoDescriçãoDoCombustívelDivergeDaDescrição = "347";
	...
	public static final String LBR_NFEANSWERSTATUS_351_RejeiçãoValorDoICMSDaOperaçãoNoICMS_STEq51Difer = "351";
	/** 352-Rejeição: Valor do ICMS diferido no CST=51 difere do pr = 352 */
	public static final String LBR_NFEANSWERSTATUS_352_RejeiçãoValorDoICMSDiferidoNoCSTEq51DifereDoPr = "352";
	/** 353-Rejeição: Valor do ICMS no CST=51 não corresponde a dif = 353 */
	public static final String LBR_NFEANSWERSTATUS_353_RejeiçãoValorDoICMSNoCSTEq51NãoCorrespondeADif = "353";
	/** 354-Rejeição: Informado grupo de devoluçãode tributos para  = 354 */
	public static final String LBR_NFEANSWERSTATUS_354_RejeiçãoInformadoGrupoDeDevoluçãodeTributosPara = "354";
	/** 355-Rejeição: Informar o local de saída do país no caso de  = 355 */
	public static final String LBR_NFEANSWERSTATUS_355_RejeiçãoInformarOLocalDeSaídaDoPaísNoCasoDe = "355";
	/** 356-Rejeição: Informar o clocal de saída do pís somente no  = 356 */
	public static final String LBR_NFEANSWERSTATUS_356_RejeiçãoInformarOClocalDeSaídaDoPísSomenteNo = "356";
	/** 357-Rejeição: Chave de acesso do grupo de exportação indire = 357 */
	public static final String LBR_NFEANSWERSTATUS_357_RejeiçãoChaveDeAcessoDoGrupoDeExportaçãoIndire = "357";
	/** 358-Rejeição: Chave de acesso no grupo de exportação indire = 358 */
	public static final String LBR_NFEANSWERSTATUS_358_RejeiçãoChaveDeAcessoNoGrupoDeExportaçãoIndire = "358";
	/** 359-Rejeição: NF-e de venda a Órgão público sem informar a  = 359 */
	public static final String LBR_NFEANSWERSTATUS_359_RejeiçãoNF_EDeVendaAÓrgãoPúblicoSemInformarA = "359";
	/** 360-Rejeição: NF-e com Nota de Empenho inválida para UF = 360 */
	public static final String LBR_NFEANSWERSTATUS_360_RejeiçãoNF_EComNotaDeEmpenhoInválidaParaUF = "360";
	...
	public static final String LBR_NFEANSWERSTATUS_362_RejeiçãoVendaDeCombustívelSemInformaçãoDoTransp = "362";
	/** 363-Rejeição: Total do ISS difere do somatório dos itens = 363 */
	public static final String LBR_NFEANSWERSTATUS_363_RejeiçãoTotalDoISSDifereDoSomatórioDosItens = "363";
	/** 364-Rejeição: Total do valor da dedução do ISS difere do so = 364 */
	public static final String LBR_NFEANSWERSTATUS_364_RejeiçãoTotalDoValorDaDeduçãoDoISSDifereDoSo = "364";
	/** 365-Rejeição: Total de outras retenções difere do somatório = 365 */
	public static final String LBR_NFEANSWERSTATUS_365_RejeiçãoTotalDeOutrasRetençõesDifereDoSomatório = "365";
	/** 366-Rejeição: Total do desconto incondicionado do ISS difer = 366 */
	public static final String LBR_NFEANSWERSTATUS_366_RejeiçãoTotalDoDescontoIncondicionadoDoISSDifer = "366";
	/** 367-Rejeição: Total do desconto condicionado do ISS difere  = 367 */
	public static final String LBR_NFEANSWERSTATUS_367_RejeiçãoTotalDoDescontoCondicionadoDoISSDifere = "367";
	/** 368-Rejeição: Total do ISS retido difere do somatório dos i = 368 */
	public static final String LBR_NFEANSWERSTATUS_368_RejeiçãoTotalDoISSRetidoDifereDoSomatórioDosI = "368";
	/** 369-Rejeição: Não informado o grupo avulsa na emissão pelo  = 369 */
	public static final String LBR_NFEANSWERSTATUS_369_RejeiçãoNãoInformadoOGrupoAvulsaNaEmissãoPelo = "369";
	/** 370-Rejeição: Nota Fiscal Avusa com tipo de emissão inválid = 370 */
	public static final String LBR_NFEANSWERSTATUS_370_RejeiçãoNotaFiscalAvusaComTipoDeEmissãoInválid = "370";
	/** 461-Rejeição: Informado percentual de gás natural na mistur = 461 */
	public static final String LBR_NFEANSWERSTATUS_461_RejeiçãoInformadoPercentualDeGásNaturalNaMistur = "461";
	...
	public static final String LBR_NFEANSWERSTATUS_663_RejeiçãoAlíqICMSMaiorQue4NaSaídaInterestadua = "663";
	/** 701-Rejeição: NF-e não pode utilizar verão 3.00 = 701 */
	public static final String LBR_NFEANSWERSTATUS_701_RejeiçãoNF_ENãoPodeUtilizarVerão300 = "701";
	...
	public static final String LBR_NFEANSWERSTATUS_703_RejeiçãoData_HoraDeEmissãoPosteriorAoHorárioDe = "703";
	...
	public static final String LBR_NFEANSWERSTATUS_705_RejeiçãoNFC_EComDataDeEntradaSaida = "705";
	...
	public static final String LBR_NFEANSWERSTATUS_707_RejeiçãoNFC_EParaOperaçãoInterestadualOuComOEx = "707";
	/** 708-Rejeição: NFC-e nao pode referenciar um documento fisca = 708 */
	public static final String LBR_NFEANSWERSTATUS_708_RejeiçãoNFC_ENaoPodeReferenciarUmDocumentoFisca = "708";
	...
	public static final String LBR_NFEANSWERSTATUS_710_RejeiçãoNF_EComFormadoDeDANFEInválido = "710";
	...
	public static final String LBR_NFEANSWERSTATUS_713_RejeiçãoTipoDeEmissãoDiferenteDe6Ou7ParaCont = "713";
	/** 714-Rejeição: NFC-e com contingência DPEC inexistente = 714 */
	public static final String LBR_NFEANSWERSTATUS_714_RejeiçãoNFC_EComContingênciaDPECInexistente = "714";
	...
	public static final String LBR_NFEANSWERSTATUS_716_RejeiçãoNFC_EEmOperaçoãNãoDestinadaAConsumidor = "716";
	...
	public static final String LBR_NFEANSWERSTATUS_718_RejeiçãoNFC_ENãoDeveInformarIEDeSubstitutoTrib = "718";
	/** 722-Rejeição: Operação interna com idEstrangeiro informado  = 722 */
	public static final String LBR_NFEANSWERSTATUS_722_RejeiçãoOperaçãoInternaComIdEstrangeiroInformado = "722";
	/** 723-Rejeição: Operação interna com idEstrangeiro informado  = 723 */
	public static final String LBR_NFEANSWERSTATUS_723_RejeiçãoOperaçãoInternaComIdEstrangeiroInformado = "723";
	...
	public static final String LBR_NFEANSWERSTATUS_726_RejeiçãoNF_ESemAInformaçãoDeEndereçoDoDestinat = "726";
	...
	public static final String LBR_NFEANSWERSTATUS_729_RejeiçãoNFC_ESemInformaçãoDaIEDoDestinatário = "729";
	...
	public static final String LBR_NFEANSWERSTATUS_732_RejeiçãoCFOPDeOperaçãoComInterestadualEIdDestLe = "732";
	...
	public static final String LBR_NFEANSWERSTATUS_739_RejeiçãoNFC_EComGrupoDeCombustíveis = "739";
	/** 740-Rejeição: NFC-e com CST 51 - diferimento = 740 */
	public static final String LBR_NFEANSWERSTATUS_740_RejeiçãoNFC_EComCST51_Diferimento = "740";
	/** 741-Rejeição: NFC-e com partilha de CIMS entre UF = 741 */
	public static final String LBR_NFEANSWERSTATUS_741_RejeiçãoNFC_EComPartilhaDeCIMSEntreUF = "741";
	...
	public static final String LBR_NFEANSWERSTATUS_748_RejeiçãoNF_ESemGrupoDoCOFINS = "748";
	/** 749-Rejeição: NF-e sem grupo do COFINS-ST = 749 */
	public static final String LBR_NFEANSWERSTATUS_749_RejeiçãoNF_ESemGrupoDoCOFINS_ST = "749";
	/** 750-Rejeição: NFC-e com valor total superior ao permitido p = 750 */
	public static final String LBR_NFEANSWERSTATUS_750_RejeiçãoNFC_EComValorTotalSuperiorAoPermitidoP = "750";
	/** 751-Rejeição: NFC-e com valor total superior ao permitido p = 751 */
	public static final String LBR_NFEANSWERSTATUS_751_RejeiçãoNFC_EComValorTotalSuperiorAoPermitidoP = "751";
	/** 752-Rejeição: NFC-e com valor total superior ao permitido p = 752 */
	public static final String LBR_NFEANSWERSTATUS_752_RejeiçãoNFC_EComValorTotalSuperiorAoPermitidoP = "752";
	/** 753-Rejeição: NFC-e sem frete = 753 */
	public static final String LBR_NFEANSWERSTATUS_753_RejeiçãoNFC_ESemFrete = "753";
	...
	public static final String LBR_NFEANSWERSTATUS_755_RejeiçãoNFC_EComDadosDeRetençãoDoICMSNoTransp = "755";
	...
	public static final String LBR_NFEANSWERSTATUS_757_RejeiçãoNFC_EComDadosDeReboqueDoVeículoDeTran = "757";
	...
	public static final String LBR_NFEANSWERSTATUS_759_RejeiçãoNFC_ECoDadosDaBalsaDeTransporte = "759";
	/** 760-Rejeição: NFC-e com dados de cobrança (fatura, duplicat = 760 */
	public static final String LBR_NFEANSWERSTATUS_760_RejeiçãoNFC_EComDadosDeCobrançaFaturaDuplicat = "760";
	/** 762-Rejeição: NFC-e com dados de compra (empenho, pedido, c = 762 */
	public static final String LBR_NFEANSWERSTATUS_762_RejeiçãoNFC_EComDadosDeCompraEmpenhoPedidoC = "762";
	...
	public static final String LBR_NFEANSWERSTATUS_766_RejeiçãoNFC_EComCST50_Suspenção = "766";
	/** 767-Rejeição: NFC-e com somatório dos pagamentos diferente  = 767 */
	public static final String LBR_NFEANSWERSTATUS_767_RejeiçãoNFC_EComSomatórioDosPagamentosDiferente = "767";
	/** 768-Rejeição: NF-e não deve possuir o grupo de formas de pa = 768 */
	public static final String LBR_NFEANSWERSTATUS_768_RejeiçãoNF_ENãoDevePossuirOGrupoDeFormasDePa = "768";
	/** 769-Rejeição: NFC-e deve possuir o grupo de formas de pagam = 769 */
	public static final String LBR_NFEANSWERSTATUS_769_RejeiçãoNFC_EDevePossuirOGrupoDeFormasDePagam = "769";
	...
	public static final String LBR_NFEANSWERSTATUS_772_RejeiçãoOperaçãoInterestadualEUFDeDestinoIgual = "772";
	/** 773-Rejeição: Operação interna e UF de destino difere da UF = 773 */
	public static final String LBR_NFEANSWERSTATUS_773_RejeiçãoOperaçãoInternaEUFDeDestinoDifereDaUF = "773";
	/** 774-Rejeição: NFC-e com indicador de item não participante  = 774 */
	public static final String LBR_NFEANSWERSTATUS_774_RejeiçãoNFC_EComIndicadorDeItemNãoParticipante = "774";
	...
	public static final String LBR_NFEANSWERSTATUS_777_RejeiçãoNFC_EDeveInformarNCMCompleto = "777";
	...
	public static final String LBR_NFEANSWERSTATUS_780_RejeiçãoTotalDaNFC_ESuperiorAoValorLimiteEstab = "780";
	/** 781-Rejeição: Emissor não habilitado para emissão de NFC-e = 781 */
	public static final String LBR_NFEANSWERSTATUS_781_RejeiçãoEmissorNãoHabilitadoParaEmissãoDeNFC_E = "781";
	...
	public static final String LBR_NFEANSWERSTATUS_783_RejeiçãoNFC_ENãoÉAutorizadaPeloSVC = "783";
	/** 784-Rejeição: NF-e com indicativo de NFC-e com entrega a do = 784 */
	public static final String LBR_NFEANSWERSTATUS_784_RejeiçãoNF_EComIndicativoDeNFC_EComEntregaADo = "784";
	/** 785-Rejeição: NFC-e com entrega a domicilio não permitida p = 785 */
	public static final String LBR_NFEANSWERSTATUS_785_RejeiçãoNFC_EComEntregaADomicilioNãoPermitidaP = "785";
	/** 786-Rejeiçao: NFC-e de entrega a domicilio sem dados dos tr = 786 */
	public static final String LBR_NFEANSWERSTATUS_786_RejeiçaoNFC_EDeEntregaADomicilioSemDadosDosTr = "786";
	/** 787-Rejeição: NFC-e de entrega a domicilio sem a identifica = 787 */
	public static final String LBR_NFEANSWERSTATUS_787_RejeiçãoNFC_EDeEntregaADomicilioSemAIdentifica = "787";
	/** 788-Rejeição: NFC-e de entrega a domicílio sem o endereço d = 788 */
	public static final String LBR_NFEANSWERSTATUS_788_RejeiçãoNFC_EDeEntregaADomicílioSemOEndereçoD = "788";
	...
	public static final String LBR_NFEANSWERSTATUS_790_RejeiçãoOperaçãoComExteriorParaDestinatárioContr = "790";
	/** 791-Rejeição: NF-e com indicação de destinatário isento de  = 791 */
	public static final String LBR_NFEANSWERSTATUS_791_RejeiçãoNF_EComIndicaçãoDeDestinatárioIsentoDe = "791";
	/** 793-Rejeição: Informado capítulo do NCM inexistente = 793 */
	public static final String LBR_NFEANSWERSTATUS_793_RejeiçãoInformadoCapítuloDoNCMInexistente = "793";
