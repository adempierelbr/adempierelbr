...
public class X_LBR_SPED extends PO implements I_LBR_SPED, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20130208L;
	...
	/** Set ToProcessSPED.
		@param ToProcessSPED ToProcessSPED	  */
	public void setToProcessSPED (String ToProcessSPED)
	{
		set_Value (COLUMNNAME_ToProcessSPED, ToProcessSPED);
	}

	/** Get ToProcessSPED.
		@return ToProcessSPED	  */
	public String getToProcessSPED () 
	{
		return (String)get_Value(COLUMNNAME_ToProcessSPED);
	}
}