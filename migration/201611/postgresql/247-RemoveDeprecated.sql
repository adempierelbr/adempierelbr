...
-- 16/12/2016 15h19min28s BRST
DELETE FROM AD_TreeNodeMM WHERE Node_ID=1000021 AND EXISTS (SELECT * FROM AD_Tree t WHERE t.AD_Tree_ID=AD_TreeNodeMM.AD_Tree_ID AND t.TreeType='MM')
;
...
-- 16/12/2016 15h19min43s BRST
DELETE FROM AD_TreeNodeMM WHERE Node_ID=1000005 AND EXISTS (SELECT * FROM AD_Tree t WHERE t.AD_Tree_ID=AD_TreeNodeMM.AD_Tree_ID AND t.TreeType='MM')
;
...
-- 16/12/2016 15h19min48s BRST
DELETE FROM AD_TreeNodeMM WHERE Node_ID=1000004 AND EXISTS (SELECT * FROM AD_Tree t WHERE t.AD_Tree_ID=AD_TreeNodeMM.AD_Tree_ID AND t.TreeType='MM')
;
...
-- 16/12/2016 15h20min21s BRST
DELETE FROM AD_TreeNodeMM WHERE Node_ID=1000036 AND EXISTS (SELECT * FROM AD_Tree t WHERE t.AD_Tree_ID=AD_TreeNodeMM.AD_Tree_ID AND t.TreeType='MM')
;
...
-- 16/12/2016 15h20min41s BRST
DELETE FROM AD_TreeNodeMM WHERE Node_ID=1000027 AND EXISTS (SELECT * FROM AD_Tree t WHERE t.AD_Tree_ID=AD_TreeNodeMM.AD_Tree_ID AND t.TreeType='MM')
;
...
-- 16/12/2016 15h20min47s BRST
DELETE FROM AD_TreeNodeMM WHERE Node_ID=1000022 AND EXISTS (SELECT * FROM AD_Tree t WHERE t.AD_Tree_ID=AD_TreeNodeMM.AD_Tree_ID AND t.TreeType='MM')
;

-- 16/12/2016 15h26min19s BRST
UPDATE AD_Table SET AD_Window_ID=NULL,Updated=TO_TIMESTAMP('2016-12-16 15:26:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=1000004
;

-- 16/12/2016 15h26min25s BRST
UPDATE AD_Table SET AD_Window_ID=NULL,Updated=TO_TIMESTAMP('2016-12-16 15:26:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=1000005
;
...
UPDATE AD_Table SET AD_Window_ID=NULL,Updated=TO_TIMESTAMP('2016-12-16 15:43:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=1000039
;

-- 16/12/2016 15h43min55s BRST
UPDATE AD_Table SET AD_Window_ID=NULL,Updated=TO_TIMESTAMP('2016-12-16 15:43:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=1000040
;
...
-- 16/12/2016 15h47min3s BRST
DELETE FROM AD_TreeNodeMM WHERE Node_ID=1000041 AND EXISTS (SELECT * FROM AD_Tree t WHERE t.AD_Tree_ID=AD_TreeNodeMM.AD_Tree_ID AND t.TreeType='MM')
;
...
-- 16/12/2016 15h47min6s BRST
DELETE FROM AD_TreeNodeMM WHERE Node_ID=1120017 AND EXISTS (SELECT * FROM AD_Tree t WHERE t.AD_Tree_ID=AD_TreeNodeMM.AD_Tree_ID AND t.TreeType='MM')
;
...
DELETE FROM AD_TreeNodeMM WHERE Node_ID=1000040 AND EXISTS (SELECT * FROM AD_Tree t WHERE t.AD_Tree_ID=AD_TreeNodeMM.AD_Tree_ID AND t.TreeType='MM')
;
...
-- 16/12/2016 15h47min18s BRST
DELETE FROM AD_TreeNodeMM WHERE Node_ID=1000039 AND EXISTS (SELECT * FROM AD_Tree t WHERE t.AD_Tree_ID=AD_TreeNodeMM.AD_Tree_ID AND t.TreeType='MM')
;
...
UPDATE AD_Table SET AD_Window_ID=NULL,Updated=TO_TIMESTAMP('2016-12-16 16:05:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=1000030
;
