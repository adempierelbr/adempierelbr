...
UPDATE AD_Process SET Description='Import the average taxes from IBPT', Help='Import average taxes from IBPT. This info is mandatory for customer invoices. You can choose getting this data online or from a CSV file.', Name='Import IBPT average taxes',Updated=TO_DATE('2017-05-19 10:41:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120126
;
...
-- 19/05/2017 10h41min19s BRT
UPDATE AD_Menu SET Description='Import the average taxes from IBPT', IsActive='Y', Name='Import IBPT average taxes',Updated=TO_DATE('2017-05-19 10:41:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=1120195
;
...
UPDATE AD_Process_Para SET DisplayLogic='@OProcessing@!Y',Updated=TO_DATE('2017-05-19 10:49:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120143
;

-- 19/05/2017 10h50min37s BRT
UPDATE AD_Process_Para_Trl SET IsTranslated='Y',Name='Obter dados online via API',Description='Obtém os dados do IBPT via API online',Updated=TO_DATE('2017-05-19 10:50:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120354 AND AD_Language='pt_BR'
;

-- 19/05/2017 10h53min49s BRT
UPDATE AD_Process_Para SET DefaultValue='0',Updated=TO_DATE('2017-05-19 10:53:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120214
;

-- 19/05/2017 10h53min53s BRT
UPDATE AD_Process_Para SET DefaultValue='-1',Updated=TO_DATE('2017-05-19 10:53:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120214
;

-- 19/05/2017 10h54min50s BRT
UPDATE AD_Process_Para SET AD_Element_ID=113, AD_Reference_Value_ID=322, AD_Val_Rule_ID=NULL, ColumnName='AD_Org_ID', DefaultValue=NULL, Name='Organização', SeqNo=7,Updated=TO_DATE('2017-05-19 10:54:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120214
;
...
UPDATE AD_Process_Para_Trl SET IsTranslated='Y',Name='Organização',Updated=TO_DATE('2017-05-19 10:54:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120214 AND AD_Language='pt_BR'
;

--	Create indexes
CREATE UNIQUE INDEX LBR_NCM_Value
	ON LBR_NCM (AD_Client_ID, Value)
;
CREATE UNIQUE INDEX LBR_IBPTax_NCM_Version
	ON LBR_IBPTax (AD_Client_ID, LBR_NCM_ID, Version)
;
CREATE UNIQUE INDEX LBR_IBPTax_NBS_Version
	ON LBR_IBPTax (AD_Client_ID, LBR_NBS_ID, Version)
;
