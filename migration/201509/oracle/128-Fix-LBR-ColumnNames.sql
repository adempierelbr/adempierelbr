...
UPDATE AD_Element SET ColumnName='LBR_BookNo', Name='Book No', PrintName='Book No',Updated=TO_DATE('2015-08-19 14:24:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1121272
;
...
-- 19/08/2015 14h24min49s BRT
UPDATE AD_PrintFormatItem pi SET PrintName='Book No', Name='Book No' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=1121272)
;

-- 19/08/2015 14h27min21s BRT
ALTER TABLE LBR_TaxAssessment ADD LBR_BookNo NUMBER(10) NOT NULL DEFAULT 0
;

-- 19/08/2015 14h29min11s BRT
UPDATE AD_Element SET ColumnName='LBR_HasWithhold', Description='Defines if the Tax, has Withhold', Help='Defines if the Tax, has Withhold', Name='Has Withhold', PrintName='Has Withhold',Updated=TO_DATE('2015-08-19 14:29:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000171
;
...
-- 19/08/2015 14h29min11s BRT
UPDATE AD_PrintFormatItem pi SET PrintName='Has Withhold', Name='Has Withhold' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=1000171)
;

-- 19/08/2015 14h29min51s BRT
ALTER TABLE C_Order ADD LBR_HasWithhold CHAR(1) DEFAULT 'Y' CHECK (LBR_HasWithhold IN ('Y','N'))
;

-- 19/08/2015 14h30min5s BRT
ALTER TABLE C_BPartner ADD LBR_HasWithhold CHAR(1) DEFAULT 'Y' CHECK (LBR_HasWithhold IN ('Y','N')) NOT NULL
;

-- 19/08/2015 14h30min20s BRT
ALTER TABLE C_Invoice ADD LBR_HasWithhold CHAR(1) DEFAULT 'Y' CHECK (LBR_HasWithhold IN ('Y','N')) NOT NULL
;
...
UPDATE AD_Element SET ColumnName='LBR_PageNo', Name='Page No', PrintName='Page No',Updated=TO_DATE('2015-08-19 14:31:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1121273
;
...
-- 19/08/2015 14h31min3s BRT
UPDATE AD_PrintFormatItem pi SET PrintName='Page No', Name='Page No' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=1121273)
;

-- 19/08/2015 14h31min8s BRT
UPDATE AD_Element_Trl SET PrintName='Número da Página',Updated=TO_DATE('2015-08-19 14:31:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1121273 AND AD_Language='pt_BR'
;

-- 19/08/2015 14h31min31s BRT
ALTER TABLE LBR_TaxAssessment ADD LBR_PageNo NUMBER(10) NOT NULL DEFAULT 0
;

-- 19/08/2015 14h32min1s BRT
UPDATE AD_Element SET ColumnName='LBR_ProcCancelBoleto',Updated=TO_DATE('2015-08-19 14:32:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000299
;
...
ALTER TABLE C_Invoice ADD LBR_ProcCancelBoleto CHAR(1) DEFAULT NULL 
;

-- 19/08/2015 14h32min34s BRT
UPDATE AD_Element SET ColumnName='LBR_ProcCancelProduction',Updated=TO_DATE('2015-08-19 14:32:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1120547
;
...
ALTER TABLE M_Production ADD LBR_ProcCancelProduction CHAR(1) DEFAULT NULL 
;

-- 19/08/2015 14h32min58s BRT
UPDATE AD_Element SET ColumnName='LBR_ProcCreatePO',Updated=TO_DATE('2015-08-19 14:32:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000285
;
...
ALTER TABLE C_Order ADD LBR_ProcCreatePO CHAR(1) DEFAULT NULL 
;

-- 19/08/2015 14h34min41s BRT
UPDATE AD_Element SET ColumnName='LBR_Processing2',Updated=TO_DATE('2015-08-19 14:34:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000271
;
...
ALTER TABLE LBR_NotaFiscal ADD LBR_Processing2 CHAR(1) DEFAULT NULL 
;

-- 19/08/2015 14h35min17s BRT
ALTER TABLE LBR_NFeLot ADD LBR_Processing2 CHAR(1) DEFAULT 'N'
;

-- 19/08/2015 14h35min38s BRT
UPDATE AD_Element SET ColumnName='LBR_ProcReactivateNF',Updated=TO_DATE('2015-08-19 14:35:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000320
;
...
ALTER TABLE LBR_NotaFiscal ADD LBR_ProcReactivateNF CHAR(1) DEFAULT NULL 
;

-- 19/08/2015 14h37min20s BRT
UPDATE AD_Column SET AD_Element_ID=524, ColumnName='Processing', Description=NULL, Help=NULL, Name='Process Now',Updated=TO_DATE('2015-08-19 14:37:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1124150
;
...
ALTER TABLE LBR_SPED ADD Processing CHAR(1) DEFAULT NULL 
;
...
UPDATE AD_Element SET ColumnName='LBR_WithholdThreshold', Description='Defines the Withhold Threshold ', Help='Defines the Withhold Threshold ', Name='Withhold Threshold', PrintName='Withhold Threshold',Updated=TO_DATE('2015-08-19 14:38:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000172
;
...
-- 19/08/2015 14h38min22s BRT
UPDATE AD_PrintFormatItem pi SET PrintName='Withhold Threshold', Name='Withhold Threshold' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=1000172)
;

-- 19/08/2015 14h38min53s BRT
UPDATE AD_Column SET DefaultValue='0',Updated=TO_DATE('2015-08-19 14:38:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000454
;

-- 19/08/2015 14h38min54s BRT
ALTER TABLE LBR_TaxName ADD LBR_WithholdThreshold NUMBER DEFAULT 0 NOT NULL
;

-- 19/08/2015 14h39min11s BRT
UPDATE AD_Element SET ColumnName='LBR_TaxRegime',Updated=TO_DATE('2015-08-19 14:39:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1121529
;
...
ALTER TABLE AD_OrgInfo ADD LBR_TaxRegime CHAR(1) DEFAULT NULL 
;
...
UPDATE AD_Field SET DisplayLogic='@lbr_TaxType@=''S'' & @LBR_HasWithhold@=Y',Updated=TO_DATE('2015-08-19 15:09:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125409
;

-- 19/08/2015 15h9min47s BRT
UPDATE AD_Field SET DisplayLogic='@lbr_TaxType@=''S'' & @LBR_HasWithhold@=Y & @LBR_WithholdType@=T',Updated=TO_DATE('2015-08-19 15:09:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125411
;

-- 19/08/2015 15h9min51s BRT
UPDATE AD_Field SET DisplayLogic='@lbr_TaxType@=''S'' & @LBR_HasWithhold@=''Y''',Updated=TO_DATE('2015-08-19 15:09:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000266
;

-- 19/08/2015 15h11min49s BRT
UPDATE AD_Field SET DisplayLogic='@lbr_TaxType@=''S'' & @LBR_HasWithhold@=''Y''',Updated=TO_DATE('2015-08-19 15:11:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000431
;

-- 19/08/2015 15h25min53s BRT
UPDATE AD_Column SET IsIdentifier='Y', SeqNo=1,Updated=TO_DATE('2015-08-19 15:25:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1124172
;
