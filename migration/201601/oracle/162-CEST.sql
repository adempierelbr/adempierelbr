...
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_FieldGroup_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,1128694,1120057,1125683,0,1000021,TO_DATE('2015-12-18 14:37:55','YYYY-MM-DD HH24:MI:SS'),100,22,'LBRA','Y','Y','N','N','N','N','N','Y','CEST Name',999,0,TO_DATE('2015-12-18 14:37:55','YYYY-MM-DD HH24:MI:SS'),100)
;
...
;
INSERT INTO LBR_NCM_CEST(SELECT n.LBR_NCM_ID, c.LBR_CEST_ID, 0, 0, 'Y', NOW(), 0, NOW(), 0 FROM LBR_NCM n, LBR_CEST c WHERE n.Value LIKE '8517.70.21%' AND c.Value = '21.084.00' AND NOT EXISTS (SELECT '1' FROM LBR_NCM_CEST nc WHERE nc.LBR_NCM_ID=n.LBR_NCM_ID AND nc.LBR_CEST_ID=c.LBR_CEST_ID))
;
INSERT INTO LBR_NCM_CEST(SELECT n.LBR_NCM_ID, c.LBR_CEST_ID, 0, 0, 'Y', NOW(), 0, NOW(), 0 FROM LBR_NCM n, LBR_CEST c WHERE n.Value LIKE '8214.90 8510%' AND c.Value = '21.085.00' AND NOT EXISTS (SELECT '1' FROM LBR_NCM_CEST nc WHERE nc.LBR_NCM_ID=n.LBR_NCM_ID AND nc.LBR_CEST_ID=c.LBR_CEST_ID))
;
...
;
INSERT INTO LBR_NCM_CEST(SELECT n.LBR_NCM_ID, c.LBR_CEST_ID, 0, 0, 'Y', NOW(), 0, NOW(), 0 FROM LBR_NCM n, LBR_CEST c WHERE n.Value LIKE 'Máxima superior a 3,9 toneladas%' AND c.Value = '25.019.00' AND NOT EXISTS (SELECT '1' FROM LBR_NCM_CEST nc WHERE nc.LBR_NCM_ID=n.LBR_NCM_ID AND nc.LBR_CEST_ID=c.LBR_CEST_ID))
;
