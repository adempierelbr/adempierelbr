...
UPDATE AD_Column SET AD_Element_ID=265, ColumnName='DateDoc', Description='Date of the Document', Help='The Document Date indicates the date the document was generated.  It may or may not be the same as the accounting date.', Name='Document Date',Updated=TO_DATE('2019-05-06 11:40:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000049
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET AD_Element_ID=265, ColumnName='DateDoc', Description='Date of the Document', Help='The Document Date indicates the date the document was generated.  It may or may not be the same as the accounting date.', Name='Document Date',Updated=TO_DATE('2019-05-06 11:40:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000238
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET AD_Element_ID=265, ColumnName='DateDoc', Description='Date of the Document', Help='The Document Date indicates the date the document was generated.  It may or may not be the same as the accounting date.', Name='Document Date',Updated=TO_DATE('2019-05-06 11:41:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1129755
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET AD_Element_ID=265, ColumnName='DateDoc',Updated=TO_DATE('2019-05-06 11:43:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1000003
;

-- 06/05/2019 11h44min0s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET AD_Element_ID=265, ColumnName='DateDoc',Updated=TO_DATE('2019-05-06 11:44:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1000013
;
...
-- 06/05/2019 11h40min22s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_Boleto MODIFY LBR_DocDate NULL;
