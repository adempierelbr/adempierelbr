...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='0 - Contratação do Frete por conta do Remetente (CIF)',Updated=TO_DATE('2018-06-01 13:26:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121327 AND AD_Language='pt_BR'
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='1 - Contratação do Frete por conta do Destinatário (FOB)',Updated=TO_DATE('2018-06-01 13:26:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121328 AND AD_Language='pt_BR'
;
...
-- NF-e 4.0
ALTER TABLE LBR_NFeEvent ADD lbr_NFModel NVARCHAR2(2) DEFAULT NULL 
;

-- 30/05/2018 13h43min59s BRT
-- NF-e 4.0
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1130286,3065,0,10,1120247,'Protocol',TO_DATE('2018-05-30 13:43:59','YYYY-MM-DD HH24:MI:SS'),100,'Protocol','LBRA',60,'Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Protocol',0,TO_DATE('2018-05-30 13:43:59','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- NF-e 4.0
ALTER TABLE LBR_NFeEvent ADD Protocol NVARCHAR2(60) DEFAULT NULL 
;

-- 30/05/2018 13h44min15s BRT
-- NF-e 4.0
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1130284,1127368,0,1120049,TO_DATE('2018-05-30 13:44:14','YYYY-MM-DD HH24:MI:SS'),100,'Identifies the model of Nota Fiscal',2,'LBRA','Y','Y','Y','N','N','N','N','N','NF Model',TO_DATE('2018-05-30 13:44:14','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- 30/05/2018 13h44min15s BRT
-- NF-e 4.0
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1130286,1127369,0,1120049,TO_DATE('2018-05-30 13:44:15','YYYY-MM-DD HH24:MI:SS'),100,'Protocol',60,'LBRA','Y','Y','Y','N','N','N','N','N','Protocol',TO_DATE('2018-05-30 13:44:15','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- NF-e 4.0
UPDATE AD_Field SET SeqNo=85,Updated=TO_DATE('2018-05-30 13:45:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1127368
;

-- 30/05/2018 13h45min36s BRT
-- NF-e 4.0
UPDATE AD_Field SET IsSameLine='Y', SeqNo=86,Updated=TO_DATE('2018-05-30 13:45:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1127369
;

-- 30/05/2018 13h47min35s BRT
-- NF-e 4.0
UPDATE AD_Field SET DisplayLogic='@LBR_NotaFiscal_ID@=0 & @LBR_PartnerDFe_ID@=0',Updated=TO_DATE('2018-05-30 13:47:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1127368
;

-- 30/05/2018 13h47min43s BRT
-- NF-e 4.0
UPDATE AD_Field SET DisplayLogic='@LBR_NotaFiscal_ID@=0 & @LBR_PartnerDFe_ID@=0',Updated=TO_DATE('2018-05-30 13:47:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1127369
;

-- 30/05/2018 13h48min20s BRT
-- NF-e 4.0
UPDATE AD_Field SET DefaultValue='55',Updated=TO_DATE('2018-05-30 13:48:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1127368
;

-- 30/05/2018 13h51min31s BRT
-- NF-e 4.0
UPDATE AD_Field SET DisplayLogic='@LBR_NotaFiscal_ID@=0 & @LBR_PartnerDFe_ID@=0 & @LBR_EventType@=''110111''',Updated=TO_DATE('2018-05-30 13:51:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1127369
;
...
-- NF-e 4.0
ALTER TABLE LBR_NFeWebService ADD C_City_ID NUMBER(10) DEFAULT NULL 
;

-- 30/05/2018 14h11min11s BRT
-- NF-e 4.0
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1130287,1127370,0,1120000,TO_DATE('2018-05-30 14:11:10','YYYY-MM-DD HH24:MI:SS'),100,'City',10,'U','City in a country','Y','Y','Y','N','N','N','N','N','City',TO_DATE('2018-05-30 14:11:10','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- NF-e 4.0
INSERT INTO AD_Val_Rule (AD_Client_ID,AD_Org_ID,AD_Val_Rule_ID,Code,Created,CreatedBy,Description,EntityType,IsActive,Name,Type,Updated,UpdatedBy) VALUES (0,0,1120144,'C_Region.C_Country_ID=139 AND C_Region.Name IN (''AC'',''BA'',''CE'',''GO'',''MS'',''MT'',''PB'',''PR'',''RN'',''RS'',''SC'',''SP'')',TO_DATE('2018-05-30 14:14:45','YYYY-MM-DD HH24:MI:SS'),100,'UFs com serviço de Consulta de Cadastro habilitadas','LBRA','Y','C_Region (Brazil Consulta Cadastro)','S',TO_DATE('2018-05-30 14:14:45','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 30/05/2018 14h15min5s BRT
-- NF-e 4.0
UPDATE AD_Process_Para SET AD_Val_Rule_ID=1120144,Updated=TO_DATE('2018-05-30 14:15:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120211
;

-- 01/06/2018 14h1min21s BRT
-- NF-e 4.0
UPDATE AD_Ref_List SET Description='Deprecated, use new values from NFe', IsActive='N',Updated=TO_DATE('2018-06-01 14:01:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1000063
;
...
-- NF-e 4.0
UPDATE AD_Ref_List SET Description='Deprecated, use new values from NFe', IsActive='N',Updated=TO_DATE('2018-06-01 14:01:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1000062
;
...
-- NF-e 4.0
UPDATE AD_Ref_List SET Description='Deprecated, use new values from NFe', IsActive='N',Updated=TO_DATE('2018-06-01 14:01:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1000064
;
...
-- NF-e 4.0
UPDATE AD_Ref_List SET Description='Deprecated, use new values from NFe', IsActive='N',Updated=TO_DATE('2018-06-01 14:01:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1000061
;
...
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121884,1000035,TO_DATE('2018-06-01 14:02:22','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Cash',TO_DATE('2018-06-01 14:02:22','YYYY-MM-DD HH24:MI:SS'),100,'01')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Dinheiro',Updated=TO_DATE('2018-06-01 14:02:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121884 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h2min49s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121885,1000035,TO_DATE('2018-06-01 14:02:49','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Check',TO_DATE('2018-06-01 14:02:49','YYYY-MM-DD HH24:MI:SS'),100,'02')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Cheque',Updated=TO_DATE('2018-06-01 14:02:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121885 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h3min10s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121886,1000035,TO_DATE('2018-06-01 14:03:09','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Credit Card',TO_DATE('2018-06-01 14:03:09','YYYY-MM-DD HH24:MI:SS'),100,'03')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Cartão de Crédito',Updated=TO_DATE('2018-06-01 14:03:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121886 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h3min33s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121887,1000035,TO_DATE('2018-06-01 14:03:32','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Debit Card',TO_DATE('2018-06-01 14:03:32','YYYY-MM-DD HH24:MI:SS'),100,'04')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Cartão de Débito',Updated=TO_DATE('2018-06-01 14:03:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121887 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h4min0s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121888,1000035,TO_DATE('2018-06-01 14:04:00','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Store Credit',TO_DATE('2018-06-01 14:04:00','YYYY-MM-DD HH24:MI:SS'),100,'05')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Crédito na Loja',Updated=TO_DATE('2018-06-01 14:04:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121888 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h4min37s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121889,1000035,TO_DATE('2018-06-01 14:04:36','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Food Voucher',TO_DATE('2018-06-01 14:04:36','YYYY-MM-DD HH24:MI:SS'),100,'10')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Vale Alimentação',Updated=TO_DATE('2018-06-01 14:04:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121889 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h4min58s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121890,1000035,TO_DATE('2018-06-01 14:04:58','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Meal Voucher',TO_DATE('2018-06-01 14:04:58','YYYY-MM-DD HH24:MI:SS'),100,'11')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Vale Refeição',Updated=TO_DATE('2018-06-01 14:05:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121890 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h5min28s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121891,1000035,TO_DATE('2018-06-01 14:05:28','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Gift Card',TO_DATE('2018-06-01 14:05:28','YYYY-MM-DD HH24:MI:SS'),100,'12')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Vale Presente',Updated=TO_DATE('2018-06-01 14:05:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121891 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h5min48s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121892,1000035,TO_DATE('2018-06-01 14:05:48','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Fuel Voucher',TO_DATE('2018-06-01 14:05:48','YYYY-MM-DD HH24:MI:SS'),100,'13')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Vale Combustível',Updated=TO_DATE('2018-06-01 14:05:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121892 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h7min34s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121893,1000035,TO_DATE('2018-06-01 14:07:34','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Trade Bill',TO_DATE('2018-06-01 14:07:34','YYYY-MM-DD HH24:MI:SS'),100,'14')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Duplicata Mercantil',Updated=TO_DATE('2018-06-01 14:07:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121893 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h8min18s BRT
-- NF-e 4.0
UPDATE AD_Ref_List SET Description='De-activate on revision 1.51 of Nota Técnica 2016.002',Updated=TO_DATE('2018-06-01 14:08:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121893
;
...
-- NF-e 4.0
UPDATE AD_Ref_List SET IsActive='N',Updated=TO_DATE('2018-06-01 14:08:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121893
;

-- 01/06/2018 14h8min37s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121894,1000035,TO_DATE('2018-06-01 14:08:37','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Bill',TO_DATE('2018-06-01 14:08:37','YYYY-MM-DD HH24:MI:SS'),100,'15')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Boleto Bancário',Updated=TO_DATE('2018-06-01 14:08:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121894 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h9min7s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121895,1000035,TO_DATE('2018-06-01 14:09:07','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','No Payment Required',TO_DATE('2018-06-01 14:09:07','YYYY-MM-DD HH24:MI:SS'),100,'90')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Sem Pagamento',Updated=TO_DATE('2018-06-01 14:09:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121895 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h9min26s BRT
-- NF-e 4.0
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121896,1000035,TO_DATE('2018-06-01 14:09:26','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Other',TO_DATE('2018-06-01 14:09:26','YYYY-MM-DD HH24:MI:SS'),100,'99')
;
...
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Name='Outros',Updated=TO_DATE('2018-06-01 14:09:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121896 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h14min20s BRT
-- NF-e 4.0
UPDATE AD_Ref_List_Trl SET IsTranslated='Y',Updated=TO_DATE('2018-06-01 14:14:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121893 AND AD_Language='pt_BR'
;

-- 01/06/2018 14h20min38s BRT
-- NF-e 4.0
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1130288,1000305,0,17,1000035,1000027,'lbr_PaymentRule',TO_DATE('2018-06-01 14:20:37','YYYY-MM-DD HH24:MI:SS'),100,'How you pay the invoice','U',2,'The Payment Rule indicates the method of invoice payment.','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Payment Rule',0,TO_DATE('2018-06-01 14:20:37','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- NF-e 4.0
UPDATE AD_Column SET EntityType='LBRA',Updated=TO_DATE('2018-06-01 14:20:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1130288
;

-- 01/06/2018 14h20min45s BRT
-- NF-e 4.0
ALTER TABLE LBR_NotaFiscal ADD lbr_PaymentRule NVARCHAR2(2) DEFAULT NULL 
;

-- 01/06/2018 14h21min11s BRT
-- NF-e 4.0
UPDATE AD_Column SET FieldLength=2,Updated=TO_DATE('2018-06-01 14:21:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000905
;

-- 01/06/2018 14h21min15s BRT
-- NF-e 4.0
ALTER TABLE C_Order MODIFY lbr_PaymentRule NVARCHAR2(2) DEFAULT NULL 
;

-- 01/06/2018 14h21min36s BRT
-- NF-e 4.0
UPDATE AD_Column SET FieldLength=2,Updated=TO_DATE('2018-06-01 14:21:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000907
;

-- 01/06/2018 14h21min37s BRT
-- NF-e 4.0
ALTER TABLE C_Invoice MODIFY lbr_PaymentRule NVARCHAR2(2) DEFAULT NULL 
;

-- 01/06/2018 14h21min55s BRT
-- NF-e 4.0
UPDATE AD_Column SET FieldLength=2,Updated=TO_DATE('2018-06-01 14:21:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000903
;

-- 01/06/2018 14h21min59s BRT
-- NF-e 4.0
ALTER TABLE C_BPartner MODIFY lbr_PaymentRule NVARCHAR2(2) DEFAULT NULL 
;

-- 01/06/2018 14h23min13s BRT
-- NF-e 4.0
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2018-06-01 14:23:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125797
;

-- 01/06/2018 14h23min33s BRT
-- NF-e 4.0
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,Updated,UpdatedBy) VALUES (0,1130288,1127371,0,1000020,TO_DATE('2018-06-01 14:23:33','YYYY-MM-DD HH24:MI:SS'),100,'How you pay the invoice',1,'LBRA','The Payment Rule indicates the method of invoice payment.','Y','Y','Y','N','N','N','N','Y','Payment Rule',265,TO_DATE('2018-06-01 14:23:33','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- NF-e 4.0
UPDATE AD_Field SET DisplayLogic='@lbr_HasOpenItems@=Y',Updated=TO_DATE('2018-06-01 14:29:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1127371
;

-- 01/06/2018 14h29min58s BRT
-- NF-e 4.0
UPDATE AD_Reference SET IsOrderByValue='Y',Updated=TO_DATE('2018-06-01 14:29:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=1000035
;
...
-- NF-e 4.0
UPDATE AD_Field SET DisplayLength=22, SeqNo=177,Updated=TO_DATE('2018-06-04 10:56:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1127365
;

-- 04/06/2018 10h56min55s BRT
-- NF-e 4.0
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2018-06-04 10:56:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1127364
;

-- 04/06/2018 10h57min20s BRT
-- NF-e 4.0
UPDATE AD_Field SET DisplayLogic='@LBR_ScaleProduction@=N',Updated=TO_DATE('2018-06-04 10:57:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1127364
;

-- 04/06/2018 10h57min23s BRT
-- NF-e 4.0
UPDATE AD_Field SET DisplayLogic='@LBR_ScaleProduction@=N',Updated=TO_DATE('2018-06-04 10:57:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1127365
;
