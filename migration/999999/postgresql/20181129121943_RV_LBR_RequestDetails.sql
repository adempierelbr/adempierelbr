...
UPDATE AD_Table_Trl SET Name='Detalhes de Solicitações',IsTranslated='Y',Updated=TO_TIMESTAMP('2018-11-29 17:13:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=1120607 AND AD_Language='pt_BR'
;
...
INSERT INTO AD_ReportView (AD_ReportView_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,AD_Table_ID,EntityType) VALUES (1120041,0,0,'Y',TO_TIMESTAMP('2018-11-29 11:48:30','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-11-29 11:48:30','YYYY-MM-DD HH24:MI:SS'),100,'RequestDetails',1120607,'LBRA')
;
...
UPDATE AD_Process_Trl SET IsTranslated='Y',Name='Detalhes de Solicitações',Description='Relatório para poder analisar as solicitações',Help='Relatório em que é possível fazer análises das solicitações abertas, filtrando por Período, Vencimento, Tipo de Solicitação.',Updated=TO_TIMESTAMP('2018-11-29 17:11:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120226 AND AD_Language='pt_BR'
;

-- 29/11/2018 11h51min31s BRST
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID) VALUES (1120440,0,0,'Y',TO_TIMESTAMP('2018-11-29 11:51:30','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-11-29 11:51:30','YYYY-MM-DD HH24:MI:SS'),100,'Created','Date this record was created','The Created field indicates the date that this record was created.',1120226,10,15,'Y',0,'N','Created','Y','LBRA',245)
;
...
INSERT INTO AD_Menu (AD_Menu_ID,Name,Description,"action",AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsSummary,AD_Process_ID,IsSOTrx,IsReadOnly,EntityType,IsCentrallyMaintained) VALUES (1120317,'Request Details','Request Details Report','R',0,0,'Y',TO_TIMESTAMP('2018-11-29 12:02:03','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-11-29 12:02:03','YYYY-MM-DD HH24:MI:SS'),100,'N',1120226,'N','N','LBRA','Y')
;

-- 29/11/2018 17h12min58s BRST
UPDATE AD_Menu_Trl SET IsTranslated='Y',Name='Detalhes de Solicitações',Updated=TO_TIMESTAMP('2018-11-29 17:12:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=1120317 AND AD_Language='pt_BR'
;
