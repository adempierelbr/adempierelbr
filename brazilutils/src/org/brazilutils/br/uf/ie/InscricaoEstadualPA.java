...
/**
 * Represents the Inscricao Estadual of Par� - PA<br>
 * 
 * <a href="http://www.sintegra.gov.br/Cad_Estados/cad_PA.html">
 * http://www.sintegra.gov.br/Cad_Estados/cad_PA.html</a>
 * 
 * @author Douglas Siviotti
 */
public final class InscricaoEstadualPA extends InscricaoEstadual {
    ...
    public boolean isValid() {
        // State Digits : 1(pos 0) and 5(pos 1) 
        if (!isFixDigitCorrect(0, '1')) return false;
        if (!isFixDigitCorrect(1, '5')) return false; 
