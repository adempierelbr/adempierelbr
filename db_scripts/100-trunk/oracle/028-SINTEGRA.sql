...
-- Default comment for updating dictionary
UPDATE AD_Column SET EntityType='LBRA',Updated=TO_DATE('2009-04-13 19:15:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1100015
;

-- 13/04/2009 19h16min7s BRT
-- Default comment for updating dictionary
ALTER TABLE AD_OrgInfo ADD lbr_LegalEntity NVARCHAR2(60)
;

-- 13/04/2009 19h16min32s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,SeqNo,CreatedBy,Updated,ColumnName,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,IsSyncDatabase,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsEncrypted,IsAlwaysUpdateable) VALUES (1100016,228,'LBRA',0,'N','N','N',0,100,TO_DATE('2009-04-13 19:16:32','YYYY-MM-DD HH24:MI:SS'),'ContactName','N',0,0,'Business Partner Contact Name','Contact Name','Y',60,'N',10,'N',TO_DATE('2009-04-13 19:16:32','YYYY-MM-DD HH24:MI:SS'),'Y','N',1839,100,'N','N')
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (IsEncrypted,UpdatedBy,AD_Org_ID,Description,IsActive,Created,AD_Client_ID,DisplayLength,Name,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,AD_Field_ID,CreatedBy,Updated,IsReadOnly,Help,EntityType) VALUES ('N',100,0,'Facsimile number','Y',TO_DATE('2009-04-13 19:18:09','YYYY-MM-DD HH24:MI:SS'),0,22,'Fax','Y','N','N',1100018,'N','Y',170,1100001,100,TO_DATE('2009-04-13 19:18:09','YYYY-MM-DD HH24:MI:SS'),'N','The Fax identifies a facsimile number for this Business Partner or  Location','U')
;
...
-- 13/04/2009 19h18min10s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Field (IsEncrypted,UpdatedBy,AD_Org_ID,Description,IsActive,Created,AD_Client_ID,DisplayLength,Name,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,AD_Field_ID,CreatedBy,Updated,IsReadOnly,Help,EntityType) VALUES ('N',100,0,'Identifies a telephone number','Y',TO_DATE('2009-04-13 19:18:10','YYYY-MM-DD HH24:MI:SS'),0,22,'Phone','Y','N','N',1100017,'N','Y',170,1100003,100,TO_DATE('2009-04-13 19:18:10','YYYY-MM-DD HH24:MI:SS'),'N','The Phone field identifies a telephone number','LBRA')
;
...
-- Default comment for updating dictionary
UPDATE AD_Field SET DisplayLength=22, SeqNo=180, AD_FieldGroup_ID=1000000, DisplayLogic='@AD_Language@=''pt_BR''',Updated=TO_DATE('2009-04-13 19:21:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1100000
;

-- 13/04/2009 19h21min29s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET DisplayLength=22, SeqNo=175, AD_FieldGroup_ID=1000000, DisplayLogic='@AD_Language@=''pt_BR''',Updated=TO_DATE('2009-04-13 19:21:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1100002
;

-- 13/04/2009 19h21min35s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-04-13 19:21:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1100000
;

-- 13/04/2009 19h21min51s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET SeqNo=190, AD_FieldGroup_ID=1000000, DisplayLogic='@AD_Language@=''pt_BR''',Updated=TO_DATE('2009-04-13 19:21:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1100003
;

-- 13/04/2009 19h22min3s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET IsSameLine='Y', SeqNo=200, AD_FieldGroup_ID=1000000, DisplayLogic='@AD_Language@=''pt_BR''',Updated=TO_DATE('2009-04-13 19:22:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1100001
;

-- 13/04/2009 19h45min41s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,SeqNo,CreatedBy,Updated,ColumnName,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,IsSyncDatabase,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsEncrypted,IsAlwaysUpdateable) VALUES (1100019,1000027,'LBRA',0,'N','N','N',0,100,TO_DATE('2009-04-13 19:45:40','YYYY-MM-DD HH24:MI:SS'),'lbr_IsOwnDocument','Identifies this is an own document','N',0,0,'Identifies this is an own document','Is Own Document','Y',1,'N',20,'N',TO_DATE('2009-04-13 19:45:40','YYYY-MM-DD HH24:MI:SS'),'Y','N',1000256,100,'N','N')
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_NotaFiscal ADD lbr_IsOwnDocument CHAR(1) CHECK (lbr_IsOwnDocument IN ('Y','N'))
;

-- 13/04/2009 19h46min8s BRT
-- Default comment for updating dictionary
UPDATE AD_Column SET DefaultValue='N', IsMandatory='Y',Updated=TO_DATE('2009-04-13 19:46:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1100019
;

-- 13/04/2009 19h46min9s BRT
-- Default comment for updating dictionary
ALTER TABLE LBR_NotaFiscal MODIFY lbr_IsOwnDocument CHAR(1) DEFAULT 'N'
;
...
-- 13/04/2009 19h46min12s BRT
-- Default comment for updating dictionary
ALTER TABLE LBR_NotaFiscal MODIFY lbr_IsOwnDocument NOT NULL
;

--	Alteração para deixar compativel com o passado
UPDATE LBR_NotaFiscal SET lbr_IsOwnDocument = NVL((SELECT dt.lbr_IsOwnDocument FROM C_DocType dt, C_Invoice i WHERE i.C_Invoice_ID=LBR_NotaFiscal.C_Invoice_ID AND i.C_DocTypeTarget_ID=dt.C_DocType_ID), (CASE WHEN IsSOTrx='Y' THEN 'Y' ELSE 'N' END))
;
