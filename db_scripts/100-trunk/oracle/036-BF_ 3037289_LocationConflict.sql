...
-- 14/09/2010 10h48min54s BRT
-- Default comment for updating dictionary
DELETE AD_Element WHERE UPPER(ColumnName)='ORG_LOCATION_ID'
;

-- 14/09/2010 10h48min54s BRT
-- Default comment for updating dictionary
UPDATE AD_Element SET ColumnName='Org_Location_ID',Updated=TO_DATE('2010-09-14 10:48:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1874
;
