...
-- Default comment for updating dictionary
UPDATE AD_Element SET ColumnName='Org_Location_ID',Updated=TO_TIMESTAMP('2009-03-10 23:51:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1874
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_NotaFiscal ADD COLUMN Org_Location_ID NUMERIC(10)
;
