...
-- Default comment for updating dictionary
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1000358,0,'Ship_Location_ID',TO_TIMESTAMP('2009-03-09 11:09:48','YYYY-MM-DD HH24:MI:SS'),100,'The Shipment Location ID','LBRA','The Shipment Location ID','Y','Ship Location','Ship Location',TO_TIMESTAMP('2009-03-09 11:09:48','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1001049,1000359,0,18,159,1000027,120,'Delivery_Location_ID',TO_TIMESTAMP('2009-03-09 11:24:20','YYYY-MM-DD HH24:MI:SS'),100,'The Delivery Location ID','LBRA',22,'The Delivery Location ID','Y','N','N','N','N','N','N','N','N','N','Y','Delivery Location',0,TO_TIMESTAMP('2009-03-09 11:24:20','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_NotaFiscal ADD COLUMN Delivery_Location_ID NUMERIC(10)
;
