...
UPDATE AD_Element SET Description='Number of the Customer NF', Help='Number of the Customer NF', Name='Customer NF Number', PO_Description='Number of the Vendor NF', PO_Help='Number of the Vendor NF', PO_Name='Vendor NF Number', PO_PrintName='Vendor NF Number', PrintName='Customer NF Number',Updated=TO_TIMESTAMP('2009-03-28 11:29:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000364
;
...
-- 28/03/2009 11h29min16s BRT
-- Default comment for updating dictionary
UPDATE AD_PrintFormatItem SET PrintName='Customer NF Number', Name='Customer NF Number' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=1000364)
;
