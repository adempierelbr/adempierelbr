----------------------------------------------------------------------
--		ADempiereLBR.Org
--	Atualização do Código do País (Kenos, www.kenos.com.br)
--
...
UPDATE AD_SysConfig SET Value='100-rc110/031-NFe_CountryCodes.sql',Updated=TO_TIMESTAMP('2010-05-17 01:39:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_SysConfig_ID=1100006
;