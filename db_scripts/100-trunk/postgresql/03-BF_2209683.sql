...
-- Default comment for updating dictionary
ALTER TABLE LBR_Boleto ADD COLUMN Comments VARCHAR(70)
;
...
-- Default comment for updating dictionary
ALTER TABLE C_Invoice ADD COLUMN lbr_BoletoComments VARCHAR(70)
;
...
-- Default comment for updating dictionary
ALTER TABLE C_InvoicePaySchedule ADD COLUMN lbr_BoletoComments VARCHAR(70)
;
