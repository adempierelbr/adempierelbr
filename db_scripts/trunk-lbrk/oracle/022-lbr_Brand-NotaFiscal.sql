...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1106005,0,'lbr_Brand',TO_DATE('2012-02-02 15:04:06','YYYY-MM-DD HH24:MI:SS'),100,'Brand Products of the document','U','Brand Proucts of the documento','Y','Brand','Brand',TO_DATE('2012-02-02 15:04:06','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name='Marca',PrintName='Marca',Description='Marca dos Produtos da Nota Fiscal',Help='Marca dos Produtos da Nota Fiscal',Updated=TO_DATE('2012-02-02 15:04:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1106005 AND AD_Language='pt_BR'
;

-- 02/02/2012 15h5min13s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1106073,1106005,0,10,1000027,'lbr_Brand',TO_DATE('2012-02-02 15:05:13','YYYY-MM-DD HH24:MI:SS'),100,'Brand Products of the document','U',60,'Brand Proucts of the documento','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Brand',0,TO_DATE('2012-02-02 15:05:13','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element SET Description='Brand transport volumes', Help='Brand transport volumes',Updated=TO_DATE('2012-02-02 15:06:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1106005
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Description='Marca dos Volumes transportados',Help='Marca dos Volumes transportados',Updated=TO_DATE('2012-02-02 15:07:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1106005 AND AD_Language='pt_BR'
;
