...
-- Tax Status e Legal Message na LBR_NFLineTax
ALTER TABLE LBR_NFLineTax ADD COLUMN LBR_TaxStatus_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Tax Status e Legal Message na LBR_NFLineTax
ALTER TABLE LBR_NFLineTax ADD COLUMN LBR_LegalMessage_ID NUMERIC(10) DEFAULT NULL 
;
