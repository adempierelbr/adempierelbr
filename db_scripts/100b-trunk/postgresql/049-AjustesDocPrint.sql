...
-- Default comment for updating dictionary
UPDATE AD_Field SET DisplayLogic='@lbr_IsSubDoc@=''Y''',Updated=TO_TIMESTAMP('2008-02-27 11:45:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000043
;

-- 27/02/2008 11h45min48s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET DisplayLogic='@lbr_HasSubDoc@=''Y''',Updated=TO_TIMESTAMP('2008-02-27 11:45:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000043
;
...
-- Default comment for updating dictionary
UPDATE AD_Field SET DisplayLogic='@lbr_IsSubDoc@=''Y''', IsSameLine='N', Updated=TO_TIMESTAMP('2008-02-27 11:46:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000042
;
...
-- 27/02/2008 11h47min1s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000707,0,1000001,TO_TIMESTAMP('2008-02-27 11:47:01','YYYY-MM-DD HH24:MI:SS'),100,'Identifies the ID of the SubDocument',22,'LBRA','Identifies the ID of the SubDocument','Y','Y','Y','N','N','N','N','N','SubDoc_ID (2)',TO_TIMESTAMP('2008-02-27 11:47:01','YYYY-MM-DD HH24:MI:SS'),0,100,1000635)
;
...
-- Default comment for updating dictionary
UPDATE AD_Field SET DisplayLogic='@lbr_HasSubDoc@=''Y''',Updated=TO_TIMESTAMP('2008-02-27 11:47:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000635
;

-- 27/02/2008 11h47min55s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET AD_FieldGroup_ID=104,Updated=TO_TIMESTAMP('2008-02-27 11:47:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000635
;

-- 27/02/2008 11h49min29s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET AD_FieldGroup_ID=NULL,Updated=TO_TIMESTAMP('2008-02-27 11:49:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000042
;
