...
-- Default comment for updating dictionary
ALTER TABLE M_Locator ADD COLUMN C_BPartner_ID NUMERIC(10)
;

-- 29/07/2008 18h50min6s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,2000001,1025,0,30,323,'M_InOut_ID',TO_TIMESTAMP('2008-07-29 18:50:06','YYYY-MM-DD HH24:MI:SS'),100,'Material Shipment Document','U',22,'The Material Shipment / Receipt ','Y','N','N','N','N','N','N','N','N','N','Y','Shipment/Receipt',0,TO_TIMESTAMP('2008-07-29 18:50:06','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Default comment for updating dictionary
ALTER TABLE M_Movement ADD COLUMN M_InOut_ID NUMERIC(10)
;
