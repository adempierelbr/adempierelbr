...
alter table lbr_icmsmatrix add column lbr_tax_id numeric; commit;
...
alter table lbr_taxconfig_bpartner add column lbr_tax_id numeric; commit;
...
alter table lbr_taxconfig_bpgroup add column lbr_tax_id numeric; commit;
...
alter table lbr_taxconfig_product add column lbr_tax_id numeric; commit;
...
alter table lbr_taxconfig_productgroup add column lbr_tax_id numeric commit;
...
alter table lbr_taxconfig_region add column lbr_tax_id numeric; commit;
