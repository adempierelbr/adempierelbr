...
INSERT INTO AD_Element (AD_Org_ID,AD_Element_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,AD_Client_ID,UpdatedBy) VALUES (0,1000288,'lbr_OtherRow',TO_DATE('2008-03-04 10:56:04','YYYY-MM-DD HH24:MI:SS'),100,'Defines if this field uses another row or truncate','LBRA','Defines if this field uses another row or truncate','Y','Other Row','Other Row',TO_DATE('2008-03-04 10:56:04','YYYY-MM-DD HH24:MI:SS'),0,100)
;
...
-- Default comment for updating dictionary
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2008-03-04 10:57:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000053
;
