...
-- Default comment for updating dictionary
UPDATE AD_Field SET SeqNo=195, AD_FieldGroup_ID=125,Updated=TO_DATE('2008-02-28 18:22:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000636
;

-- 28/02/2008 18h22min29s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000712,0,1000020,TO_DATE('2008-02-28 18:22:26','YYYY-MM-DD HH24:MI:SS'),100,'Defines the CFOP Note',300,'LBRA','Defines the CFOP Note','Y','Y','Y','N','N','N','N','N','CFOP Note',TO_DATE('2008-02-28 18:22:26','YYYY-MM-DD HH24:MI:SS'),0,100,1000637)
;
...
-- Default comment for updating dictionary
UPDATE AD_Field SET SeqNo=195, AD_FieldGroup_ID=125,Updated=TO_DATE('2008-02-28 18:22:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000637
;
