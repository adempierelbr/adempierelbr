...
-- Default comment for updating dictionary
ALTER TABLE AD_Sequence ADD IsRange CHAR(1) DEFAULT 'N' CHECK (IsRange IN ('Y','N')) NOT NULL
;

-- 15/04/2008 11h6min34s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Org_ID,AD_Element_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,AD_Client_ID,Version,AD_Column_ID) VALUES (0,1060,12,115,'ValueMin',TO_DATE('2008-04-15 11:06:33','YYYY-MM-DD HH24:MI:SS'),100,'Minimum Value for a field','LBRA',22,'The Minimum Value indicates the lowest  allowable value for a field.','Y','N','N','N','N','N','N','N','N','N','Y','Min. Value',0,TO_DATE('2008-04-15 11:06:33','YYYY-MM-DD HH24:MI:SS'),100,0,0,1000919)
;
...
-- Default comment for updating dictionary
ALTER TABLE AD_Sequence ADD ValueMin NUMBER
;

-- 15/04/2008 11h6min37s BRT
-- Default comment for updating dictionary
UPDATE AD_Column SET IsMandatory='Y',Updated=TO_DATE('2008-04-15 11:06:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000919
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Org_ID,AD_Element_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,AD_Client_ID,Version,AD_Column_ID) VALUES (0,1059,12,115,'ValueMax',TO_DATE('2008-04-15 11:06:53','YYYY-MM-DD HH24:MI:SS'),100,'Maximum Value for a field','LBRA',22,'The Maximum Value indicates the highest allowable value for a field','Y','N','N','N','N','N','N','N','N','N','Y','Max. Value',0,TO_DATE('2008-04-15 11:06:53','YYYY-MM-DD HH24:MI:SS'),100,0,0,1000920)
;
...
-- Default comment for updating dictionary
ALTER TABLE AD_Sequence ADD ValueMax NUMBER
;

-- 15/04/2008 11h6min57s BRT
-- Default comment for updating dictionary
UPDATE AD_Column SET IsMandatory='Y',Updated=TO_DATE('2008-04-15 11:06:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000920
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000920,0,146,TO_DATE('2008-04-15 11:09:05','YYYY-MM-DD HH24:MI:SS'),100,'Maximum Value for a field',22,'LBRA','The Maximum Value indicates the highest allowable value for a field','Y','Y','Y','N','N','N','N','N','Max. Value',TO_DATE('2008-04-15 11:09:05','YYYY-MM-DD HH24:MI:SS'),0,100,1000885)
;
...
-- 15/04/2008 11h9min5s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000919,0,146,TO_DATE('2008-04-15 11:09:05','YYYY-MM-DD HH24:MI:SS'),100,'Minimum Value for a field',22,'LBRA','The Minimum Value indicates the lowest  allowable value for a field.','Y','Y','Y','N','N','N','N','N','Min. Value',TO_DATE('2008-04-15 11:09:05','YYYY-MM-DD HH24:MI:SS'),0,100,1000886)
;
...
-- 15/04/2008 11h9min5s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000918,0,146,TO_DATE('2008-04-15 11:09:05','YYYY-MM-DD HH24:MI:SS'),100,'The parameter is a range of values',1,'LBRA','The Range checkbox indicates that this parameter is a range of values.','Y','Y','Y','N','N','N','N','N','Range',TO_DATE('2008-04-15 11:09:05','YYYY-MM-DD HH24:MI:SS'),0,100,1000887)
;
...
-- Default comment for updating dictionary
UPDATE AD_Field SET AD_FieldGroup_ID=1000000,Updated=TO_DATE('2008-04-15 11:09:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000887
;

-- 15/04/2008 11h9min37s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET DisplayLogic='@IsRange@=''Y''', AD_FieldGroup_ID=1000000,Updated=TO_DATE('2008-04-15 11:09:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000886
;

-- 15/04/2008 11h9min47s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET DisplayLogic='@IsRange@=''Y''', IsSameLine='Y', AD_FieldGroup_ID=1000000,Updated=TO_DATE('2008-04-15 11:09:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000885
;

-- 15/04/2008 11h20min18s BRT
-- Default comment for updating dictionary
UPDATE AD_Column SET AD_Reference_ID=11,Updated=TO_DATE('2008-04-15 11:20:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000920
;
...
-- Default comment for updating dictionary
UPDATE AD_Column SET IsMandatory='N',Updated=TO_DATE('2008-04-15 11:20:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000920
;
...
-- Default comment for updating dictionary
UPDATE AD_Column SET IsMandatory='Y',Updated=TO_DATE('2008-04-15 11:20:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000920
;
...
-- Default comment for updating dictionary
UPDATE AD_Column SET AD_Reference_ID=11, IsMandatory='N',Updated=TO_DATE('2008-04-15 11:20:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000919
;
...
-- Default comment for updating dictionary
ALTER TABLE AD_Sequence MODIFY ValueMin NUMBER(10) DEFAULT  NULL 
;

-- 15/04/2008 11h20min59s BRT
-- Default comment for updating dictionary
UPDATE AD_Column SET IsMandatory='Y',Updated=TO_DATE('2008-04-15 11:20:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000919
;
