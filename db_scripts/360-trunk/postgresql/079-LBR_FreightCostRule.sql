...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1121100,0,'LBR_FreightCostRule',TO_TIMESTAMP('2013-01-21 11:31:26','YYYY-MM-DD HH24:MI:SS'),100,'Method for charging Freight','U','The Freight Cost Rule indicates the method used when charging for freight.','Y','Freight Cost Rule','Freight Cost Rule',TO_TIMESTAMP('2013-01-21 11:31:26','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Reference_ID,AD_Ref_List_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1120147,1121327,TO_TIMESTAMP('2013-01-21 11:34:21','YYYY-MM-DD HH24:MI:SS'),100,'U','Y','0 - Frete por conta do Emitente',TO_TIMESTAMP('2013-01-21 11:34:21','YYYY-MM-DD HH24:MI:SS'),100,'0')
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Reference_ID,AD_Ref_List_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1120147,1121328,TO_TIMESTAMP('2013-01-21 11:34:30','YYYY-MM-DD HH24:MI:SS'),100,'U','Y','1 - Frete por conta do Destinatário',TO_TIMESTAMP('2013-01-21 11:34:30','YYYY-MM-DD HH24:MI:SS'),100,'1')
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET AD_Reference_Value_ID=1120147,Updated=TO_TIMESTAMP('2013-01-21 11:34:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1123946
;

-- 21/01/2013 11h35min45s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1123946,1123418,0,186,TO_TIMESTAMP('2013-01-21 11:35:44','YYYY-MM-DD HH24:MI:SS'),100,'Method for charging Freight',1,'U','The Freight Cost Rule indicates the method used when charging for freight.','Y','Y','Y','N','N','N','N','N','Freight Cost Rule',TO_TIMESTAMP('2013-01-21 11:35:44','YYYY-MM-DD HH24:MI:SS'),100)
;
...
VALUES (0,1123947,1123444,0,263,TO_TIMESTAMP('2013-01-21 11:39:02','YYYY-MM-DD HH24:MI:SS'),100,'Method for charging Freight',1,'U','The Freight Cost Rule indicates the method used when charging for freight.','Y','Y','Y','N','N','N','N','N','Freight Cost Rule',TO_TIMESTAMP('2013-01-21 11:39:02','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_NotaFiscal ADD COLUMN LBR_FreightCostRule CHAR(1) DEFAULT NULL 
;

-- 21/01/2013 11h42min53s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1123948,1123448,0,1000020,TO_TIMESTAMP('2013-01-21 11:42:49','YYYY-MM-DD HH24:MI:SS'),100,'Method for charging Freight',1,'U','The Freight Cost Rule indicates the method used when charging for freight.','Y','Y','Y','N','N','N','N','N','Freight Cost Rule',TO_TIMESTAMP('2013-01-21 11:42:49','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET AD_Reference_Value_ID=1120147,Updated=TO_TIMESTAMP('2013-01-21 16:13:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1123947
;
