...
-- Boleto Email
INSERT INTO AD_Message (AD_Client_ID,AD_Message_ID,AD_Org_ID,Created,CreatedBy,EntityType,IsActive,MsgText,MsgTip,MsgType,Updated,UpdatedBy,Value) VALUES (0,1120032,0,TO_TIMESTAMP('2013-03-13 14:44:33','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Prezado Cliente,
...
1 - Telefone
2 - Número do Documento da Fatura','I',TO_TIMESTAMP('2013-03-13 14:44:33','YYYY-MM-DD HH24:MI:SS'),100,'LBR_BillingEMailText')
;
