...
-- https://adempiere.atlassian.net/browse/LBR-39 - Carta de Correção Eletrônica
INSERT INTO AD_Process (AccessLevel,AD_Client_ID,AD_Org_ID,AD_Process_ID,Classname,CopyFromProcess,Created,CreatedBy,EntityType,IsActive,IsBetaFunctionality,IsDirectPrint,IsReport,IsServerProcess,Name,ShowHelp,Statistic_Count,Statistic_Seconds,Updated,UpdatedBy,Value) VALUES ('3',0,0,2000004,'org.adempierelbr.process.PrintFromXML','N',TO_TIMESTAMP('2012-05-22 15:54:07','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','N','N','Y','N','Print From XML','Y',0,0,TO_TIMESTAMP('2012-05-22 15:54:07','YYYY-MM-DD HH24:MI:SS'),100,'10000001')
;
...
-- https://adempiere.atlassian.net/browse/LBR-39 - Carta de Correção Eletrônica
UPDATE AD_Process SET Value='PrintFromXML',Updated=TO_TIMESTAMP('2012-05-22 15:54:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=2000004
;

-- 22/05/2012 15h54min27s BRT
-- https://adempiere.atlassian.net/browse/LBR-39 - Carta de Correção Eletrônica
UPDATE AD_Process_Trl SET Name='Imprime do XML',Updated=TO_TIMESTAMP('2012-05-22 15:54:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=2000004 AND AD_Language='pt_BR'
;

-- 22/05/2012 15h54min40s BRT
-- https://adempiere.atlassian.net/browse/LBR-39 - Carta de Correção Eletrônica
UPDATE AD_Process_Trl SET Name='Relatório do XML',Updated=TO_TIMESTAMP('2012-05-22 15:54:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=2000004 AND AD_Language='pt_BR'
;

-- 22/05/2012 15h55min23s BRT
-- https://adempiere.atlassian.net/browse/LBR-39 - Carta de Correção Eletrônica
UPDATE AD_Process SET EntityType='LBRA',Updated=TO_TIMESTAMP('2012-05-22 15:55:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=2000004
;

-- 22/05/2012 15h55min40s BRT
-- https://adempiere.atlassian.net/browse/LBR-39 - Carta de Correção Eletrônica
UPDATE AD_Tab SET AD_Process_ID=2000004,Updated=TO_TIMESTAMP('2012-05-22 15:55:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=1120049
;
