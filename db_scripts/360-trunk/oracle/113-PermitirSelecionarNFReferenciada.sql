...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1121731,0,'LBR_NFeReferenced',TO_DATE('2015-05-15 12:31:13','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Nota Fiscal Referenced','Nota Fiscal Referenced',TO_DATE('2015-05-15 12:31:13','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1126602,1121731,0,30,1000026,1120447,'LBR_NFeReferenced',TO_DATE('2015-05-15 12:32:53','YYYY-MM-DD HH24:MI:SS'),100,'LBRA',10,'Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Nota Fiscal Referenced',0,TO_DATE('2015-05-15 12:32:53','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_NotaFiscalDocRef ADD LBR_NFeReferenced VARCHAR2(10) DEFAULT NULL 
;

-- 15/05/2015 12h33min23s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,1126602,1125375,0,1120177,TO_DATE('2015-05-15 12:33:23','YYYY-MM-DD HH24:MI:SS'),100,0,'LBRA','Y','Y','Y','N','N','N','N','N','Nota Fiscal Referenced',180,0,TO_DATE('2015-05-15 12:33:23','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name='Nota Fiscal Referenciada',PrintName='Nota Fiscal Referenciada',Updated=TO_DATE('2015-05-15 12:52:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1121731 AND AD_Language='pt_BR'
;

-- 15/05/2015 16h37min0s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET Callout='org.adempierelbr.callout.CalloutNFeRef.NFeReferenced',Updated=TO_DATE('2015-05-15 16:37:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1126602
;
