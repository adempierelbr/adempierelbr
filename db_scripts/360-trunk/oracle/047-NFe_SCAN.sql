...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Element (Name,CreatedBy,UpdatedBy,AD_Element_ID,ColumnName,Updated,PrintName,Created,AD_Client_ID,AD_Org_ID,IsActive,EntityType) VALUES ('Motivo contingência',100,100,1120103,'lbr_MotivoScan',TO_DATE('2011-08-12 14:54:49','YYYY-MM-DD HH24:MI:SS'),'Justificativa da entrada em contingência',TO_DATE('2011-08-12 14:54:49','YYYY-MM-DD HH24:MI:SS'),0,0,'Y','LBRA')
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Element (Name,CreatedBy,UpdatedBy,AD_Element_ID,ColumnName,Updated,PrintName,Created,AD_Client_ID,AD_Org_ID,IsActive,EntityType) VALUES ('Data contingência',100,100,1120104,'lbr_DateScan',TO_DATE('2011-08-12 14:55:18','YYYY-MM-DD HH24:MI:SS'),'Data e Hora da entrada em contingência',TO_DATE('2011-08-12 14:55:18','YYYY-MM-DD HH24:MI:SS'),0,0,'Y','LBRA')
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET DisplayLength=22, SeqNo=141,Updated=TO_DATE('2011-08-12 14:56:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1120314
;

-- 12/08/2011 14h57min1s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET SeqNo=142,Updated=TO_DATE('2011-08-12 14:57:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1120313
;

-- 12/08/2011 14h57min15s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2011-08-12 14:57:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1120313
;

-- 12/08/2011 14h57min41s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET AD_FieldGroup_ID=1100002,Updated=TO_DATE('2011-08-12 14:57:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1120314
;

-- 12/08/2011 14h58min4s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET AD_FieldGroup_ID=1100002,Updated=TO_DATE('2011-08-12 14:58:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1120313
;

-- 16/08/2011 9h41min49s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET IsMandatory='N',Updated=TO_DATE('2011-08-16 09:41:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1120010
;

-- 16/08/2011 9h41min50s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_NFeWebService MODIFY C_Region_ID NUMBER(10) DEFAULT NULL 
;

-- 16/08/2011 9h41min50s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_NFeWebService MODIFY C_Region_ID NULL
;

-- 16/08/2011 9h43min41s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Element (Name,CreatedBy,UpdatedBy,AD_Element_ID,ColumnName,Updated,PrintName,Created,AD_Client_ID,AD_Org_ID,IsActive,EntityType) VALUES ('Enable Scan',100,100,1120105,'lbr_IsScan',TO_DATE('2011-08-16 09:43:40','YYYY-MM-DD HH24:MI:SS'),'Enable Scan',TO_DATE('2011-08-16 09:43:40','YYYY-MM-DD HH24:MI:SS'),0,0,'Y','LBRA')
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE AD_OrgInfo ADD lbr_IsScan CHAR(1) DEFAULT 'N' CHECK (lbr_IsScan IN ('Y','N')) NOT NULL
;

-- 16/08/2011 9h54min35s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Field_ID,DisplayLength,IsEncrypted,AD_Org_ID,IsActive,AD_Column_ID,Updated,Name,AD_Client_ID,IsDisplayed,Created,UpdatedBy,EntityType,IsReadOnly,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,CreatedBy,IsSameLine,IsHeading) VALUES (1120323,1,'N',0,'Y',1120464,TO_DATE('2011-08-16 09:54:34','YYYY-MM-DD HH24:MI:SS'),'Enable Scan',0,'Y',TO_DATE('2011-08-16 09:54:34','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','N',170,'N','Y',100,'N','N')
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET DefaultValue='1', IsMandatory='Y',Updated=TO_DATE('2011-08-16 10:22:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1120453
;

-- 16/08/2011 10h22min31s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE C_DocType MODIFY lbr_NFeTpEmi CHAR(1) DEFAULT '1'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE C_DocType MODIFY lbr_NFeTpEmi NOT NULL
;

INSERT INTO LBR_NFeWebService (LBR_NFEWEBSERVICE_ID,AD_CLIENT_ID,AD_ORG_ID,ISACTIVE,CREATED,CREATEDBY,UPDATED,UPDATEDBY,NAME,C_REGION_ID,LBR_NFEENV,VERSIONNO,URL) VALUES (1000181,0,0,'Y',sysdate,100,sysdate,100,'NfeRecepcao',null,'1','2.00','https://www.scan.fazenda.gov.br/NfeRecepcao2/NfeRecepcao2.asmx');
INSERT INTO LBR_NFeWebService (LBR_NFEWEBSERVICE_ID,AD_CLIENT_ID,AD_ORG_ID,ISACTIVE,CREATED,CREATEDBY,UPDATED,UPDATEDBY,NAME,C_REGION_ID,LBR_NFEENV,VERSIONNO,URL) VALUES (1000183,0,0,'Y',sysdate,100,sysdate,100,'NfeCancelamento',null,'1','2.00','https://www.scan.fazenda.gov.br/NfeCancelamento2/NfeCancelamento2.asmx');
INSERT INTO LBR_NFeWebService (LBR_NFEWEBSERVICE_ID,AD_CLIENT_ID,AD_ORG_ID,ISACTIVE,CREATED,CREATEDBY,UPDATED,UPDATEDBY,NAME,C_REGION_ID,LBR_NFEENV,VERSIONNO,URL) VALUES (1000185,0,0,'Y',sysdate,100,sysdate,100,'NfeConsultaProtocolo',null,'1','2.00','https://www.scan.fazenda.gov.br/NfeConsulta2/NfeConsulta2.asmx');
INSERT INTO LBR_NFeWebService (LBR_NFEWEBSERVICE_ID,AD_CLIENT_ID,AD_ORG_ID,ISACTIVE,CREATED,CREATEDBY,UPDATED,UPDATEDBY,NAME,C_REGION_ID,LBR_NFEENV,VERSIONNO,URL) VALUES (1000186,0,0,'Y',sysdate,100,sysdate,100,'NfeStatusServico',null,'1','2.00','https://www.scan.fazenda.gov.br/NfeStatusServico2/NfeStatusServico2.asmx');
INSERT INTO LBR_NFeWebService (LBR_NFEWEBSERVICE_ID,AD_CLIENT_ID,AD_ORG_ID,ISACTIVE,CREATED,CREATEDBY,UPDATED,UPDATEDBY,NAME,C_REGION_ID,LBR_NFEENV,VERSIONNO,URL) VALUES (1000182,0,0,'Y',sysdate,100,sysdate,100,'NfeRetRecepcao',null,'1','2.00','https://www.scan.fazenda.gov.br/NfeRetRecepcao2/NfeRetRecepcao2.asmx');
INSERT INTO LBR_NFeWebService (LBR_NFEWEBSERVICE_ID,AD_CLIENT_ID,AD_ORG_ID,ISACTIVE,CREATED,CREATEDBY,UPDATED,UPDATEDBY,NAME,C_REGION_ID,LBR_NFEENV,VERSIONNO,URL) VALUES (1000184,0,0,'Y',sysdate,100,sysdate,100,'NfeInutilizacao',null,'1','2.00','https://www.scan.fazenda.gov.br/NfeInutilizacao2/NfeInutilizacao2.asmx');
