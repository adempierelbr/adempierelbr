...
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1126588,306,0,12,1000028,'FreightAmt',TO_DATE('2015-03-19 10:04:18','YYYY-MM-DD HH24:MI:SS'),100,'0','Freight Amount ','LBRA',10,'The Freight Amount indicates the amount charged for Freight in the document currency.','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Freight Amount',0,TO_DATE('2015-03-19 10:04:18','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
ALTER TABLE LBR_NotaFiscalLine ADD FreightAmt NUMBER(10) DEFAULT 0 
;

-- 19/03/2015 10h4min48s BRT
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1126589,1000223,0,12,1000028,'lbr_InsuranceAmt',TO_DATE('2015-03-19 10:04:47','YYYY-MM-DD HH24:MI:SS'),100,'0','Defines the Insurance Amt','LBRA',10,'Defines the Insurance Amt','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Insurance Amt',0,TO_DATE('2015-03-19 10:04:47','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
ALTER TABLE LBR_NotaFiscalLine ADD lbr_InsuranceAmt NUMBER(10) DEFAULT 0 
;

-- 19/03/2015 10h5min7s BRT
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1126588,1124989,0,1000021,TO_DATE('2015-03-19 10:05:06','YYYY-MM-DD HH24:MI:SS'),100,'Freight Amount ',10,'LBRA','The Freight Amount indicates the amount charged for Freight in the document currency.','Y','Y','Y','N','N','N','N','N','Freight Amount',TO_DATE('2015-03-19 10:05:06','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1126589,1124990,0,1000021,TO_DATE('2015-03-19 10:05:07','YYYY-MM-DD HH24:MI:SS'),100,'Defines the Insurance Amt',10,'LBRA','Defines the Insurance Amt','Y','Y','Y','N','N','N','N','N','Insurance Amt',TO_DATE('2015-03-19 10:05:07','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Workflow SET AD_WF_Node_ID=1120083, IsValid='Y',Updated=TO_DATE('2015-03-21 19:22:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Workflow_ID=1120021
;

-- 21/03/2015 19h24min51s BRT
UPDATE AD_Column SET ReadOnlyLogic='@DocStatus@!DR',Updated=TO_DATE('2015-03-21 19:24:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1126590
;

-- 21/03/2015 19h27min3s BRT
UPDATE AD_Tab SET IsInsertRecord='Y', IsReadOnly='N',Updated=TO_DATE('2015-03-21 19:27:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=1000027
;

-- 01/04/2015 18h59min9s BRT
UPDATE AD_Column SET DefaultValue='0',Updated=TO_DATE('2015-04-01 18:59:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1123543
;

-- 01/04/2015 18h59min13s BRT
ALTER TABLE LBR_NotaFiscalLine MODIFY DiscountAmt NUMBER DEFAULT 0
;
...
SELECT register_migration_script('106-NFeInutilizadas.sql') FROM dual;