...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1121728,0,'LBR_EMailNFe',TO_DATE('2015-05-14 17:54:50','YYYY-MM-DD HH24:MI:SS'),100,'NFe EMail separated by semicolon','LBRA','NFe EMail separated by semicolon','Y','NFe EMail','NFe EMail',TO_DATE('2015-05-14 17:54:50','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='EMail NFe',PrintName='EMail NFe',Description='EMail para recepção do XML da NFe',Help='EMail para recepção do XML da NFe (para adicionar mais de um e-mail separe por vírgula ou ponto-e-vírgula)',Updated=TO_DATE('2015-05-14 17:56:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1121728 AND AD_Language='pt_BR'
;

-- 14/05/2015 17h57min1s BRT
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1121729,0,'LBR_EMailSent',TO_DATE('2015-05-14 17:57:00','YYYY-MM-DD HH24:MI:SS'),100,'Indicates if the email was sent','LBRA','Indicates if the email was sent','Y','EMail Sent','EMail Sent',TO_DATE('2015-05-14 17:57:00','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='EMail Enviado',PrintName='EMail Enviado',Description='Indica se o email foi enviado com sucesso',Help='Indica se o email foi enviado com sucesso',Updated=TO_DATE('2015-05-14 17:57:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1121729 AND AD_Language='pt_BR'
;

-- 14/05/2015 17h58min23s BRT
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1126599,1121728,0,10,291,'LBR_EMailNFe',TO_DATE('2015-05-14 17:58:21','YYYY-MM-DD HH24:MI:SS'),100,'NFe EMail separated by semicolon','LBRA',60,'NFe EMail separated by semicolon','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','NFe EMail',0,TO_DATE('2015-05-14 17:58:21','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
ALTER TABLE C_BPartner ADD LBR_EMailNFe NVARCHAR2(60) DEFAULT NULL 
;

-- 14/05/2015 17h58min48s BRT
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1126599,1125346,0,220,TO_DATE('2015-05-14 17:58:47','YYYY-MM-DD HH24:MI:SS'),100,'NFe EMail separated by semicolon',60,'LBRA','NFe EMail separated by semicolon','Y','Y','Y','N','N','N','N','N','NFe EMail',TO_DATE('2015-05-14 17:58:47','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Field SET AD_FieldGroup_ID=1000000, SeqNo=335,Updated=TO_DATE('2015-05-14 18:04:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125346
;

-- 14/05/2015 18h7min50s BRT
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1126600,1121729,0,20,1000027,'LBR_EMailSent',TO_DATE('2015-05-14 18:07:49','YYYY-MM-DD HH24:MI:SS'),100,'N','Indicates if the email was sent','LBRA',1,'Indicates if the email was sent','Y','Y','N','N','N','N','N','Y','N','N','N','N','Y','EMail Sent',0,TO_DATE('2015-05-14 18:07:49','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
ALTER TABLE LBR_NotaFiscal ADD LBR_EMailSent CHAR(1) DEFAULT 'N' CHECK (LBR_EMailSent IN ('Y','N')) NOT NULL
;

-- 14/05/2015 18h8min33s BRT
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1126600,1125370,0,1000020,TO_DATE('2015-05-14 18:08:32','YYYY-MM-DD HH24:MI:SS'),100,'Indicates if the email was sent',1,'LBRA','Indicates if the email was sent','Y','Y','Y','N','N','N','N','N','EMail Sent',TO_DATE('2015-05-14 18:08:32','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Field SET AD_FieldGroup_ID=125, IsReadOnly='Y', SeqNo=715,Updated=TO_DATE('2015-05-14 18:10:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125370
;

-- 14/05/2015 18h10min34s BRT
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1126600,1125372,0,1000028,TO_DATE('2015-05-14 18:10:33','YYYY-MM-DD HH24:MI:SS'),100,'Indicates if the email was sent',1,'LBRA','Indicates if the email was sent','Y','Y','Y','N','N','N','N','N','EMail Sent',TO_DATE('2015-05-14 18:10:33','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Field SET AD_FieldGroup_ID=125, IsReadOnly='Y', SeqNo=705,Updated=TO_DATE('2015-05-14 18:11:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125372
;

-- 14/05/2015 18h52min10s BRT
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1121730,0,'LBR_SendEMail',TO_DATE('2015-05-14 18:52:09','YYYY-MM-DD HH24:MI:SS'),100,'Send EMail with Nota Fiscal','LBRA','Send EMail with Nota Fiscal','Y','Send EMail','Send EMail',TO_DATE('2015-05-14 18:52:09','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Enviar EMail',PrintName='Enviar EMail',Description='Enviar EMail da Nota Fiscal',Help='Enviar EMail da Nota Fiscal com o XML e DANFE para Notas Fiscais modelo 55 e 56. Para RPS e Notas Fiscais de Serviço é enviado apenas o PDF da Nota Fiscal',Updated=TO_DATE('2015-05-14 19:02:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1121730 AND AD_Language='pt_BR'
;

-- 14/05/2015 19h3min46s BRT
INSERT INTO AD_Process (AD_Client_ID,AD_Org_ID,AD_Process_ID,AccessLevel,Classname,CopyFromProcess,Created,CreatedBy,Description,EntityType,Help,IsActive,IsBetaFunctionality,IsDirectPrint,IsReport,IsServerProcess,Name,ShowHelp,Statistic_Count,Statistic_Seconds,Updated,UpdatedBy,Value) VALUES (0,0,1120151,'3','org.adempierelbr.process.ProcEMailNFe','N',TO_DATE('2015-05-14 19:03:46','YYYY-MM-DD HH24:MI:SS'),100,'Send EMail with Nota Fiscal','LBRA','Send EMail with Nota Fiscal','Y','N','N','N','N','Send EMail','Y',0,0,TO_DATE('2015-05-14 19:03:46','YYYY-MM-DD HH24:MI:SS'),100,'LBR_SendEMail')
;
...
UPDATE AD_Process_Trl SET Name='Enviar EMail',Description='Enviar EMail com a Nota Fiscal',Help='Envia o EMail da Nota Fiscal com o XML e DANFE para Notas Fiscais modelo 55 e 56. Para RPS e Notas Fiscais de Serviço é enviado apenas o PDF da Nota Fiscal.',Updated=TO_DATE('2015-05-14 19:04:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120151 AND AD_Language='pt_BR'
;

-- 14/05/2015 19h5min3s BRT
UPDATE AD_Process_Trl SET IsTranslated='Y',Updated=TO_DATE('2015-05-14 19:05:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120151 AND AD_Language='pt_BR'
;

-- 14/05/2015 19h5min38s BRT
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1126601,1121730,0,1120151,28,1000027,'LBR_SendEMail',TO_DATE('2015-05-14 19:05:37','YYYY-MM-DD HH24:MI:SS'),100,'N','Send EMail with Nota Fiscal','LBRA',1,'Send EMail with Nota Fiscal','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Send EMail',0,TO_DATE('2015-05-14 19:05:37','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
ALTER TABLE LBR_NotaFiscal ADD LBR_SendEMail CHAR(1) DEFAULT 'N'
;

-- 14/05/2015 19h6min52s BRT
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_FieldGroup_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,Updated,UpdatedBy) VALUES (0,1126601,125,1125373,0,1000020,TO_DATE('2015-05-14 19:06:51','YYYY-MM-DD HH24:MI:SS'),100,'Send EMail with Nota Fiscal',1,'LBRA','Send EMail with Nota Fiscal','Y','Y','Y','N','N','N','N','Y','Send EMail',716,TO_DATE('2015-05-14 19:06:51','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_FieldGroup_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,Updated,UpdatedBy) VALUES (0,1126601,125,1125374,0,1000028,TO_DATE('2015-05-14 19:07:37','YYYY-MM-DD HH24:MI:SS'),100,'Send EMail with Nota Fiscal',1,'LBRA','Send EMail with Nota Fiscal','Y','Y','Y','N','N','N','N','Y','Send EMail',706,TO_DATE('2015-05-14 19:07:37','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Field SET DisplayLogic='@lbr_IsOwnDocument@=Y & @DocStatus@!IP & @DocStatus@!DR & @DocStatus@!WC & @DocStatus@!IN',Updated=TO_DATE('2015-05-14 19:20:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125372
;

-- 14/05/2015 19h20min10s BRT
UPDATE AD_Field SET DisplayLogic='@lbr_IsOwnDocument@=Y & @DocStatus@!IP & @DocStatus@!DR & @DocStatus@!WC & @DocStatus@!IN',Updated=TO_DATE('2015-05-14 19:20:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125374
;

-- 14/05/2015 19h20min25s BRT
UPDATE AD_Field SET DisplayLogic='@lbr_IsOwnDocument@=Y & @DocStatus@!IP & @DocStatus@!DR & @DocStatus@!WC & @DocStatus@!IN',Updated=TO_DATE('2015-05-14 19:20:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125373
;
