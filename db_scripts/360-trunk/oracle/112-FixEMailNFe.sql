...
UPDATE AD_Field SET DisplayLogic='@DocStatus@=CO | @DocStatus@=VO',Updated=TO_DATE('2015-05-14 19:20:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125372
;

-- 14/05/2015 19h20min10s BRT
UPDATE AD_Field SET DisplayLogic='@DocStatus@=CO | @DocStatus@=VO',Updated=TO_DATE('2015-05-14 19:20:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125374
;

-- 14/05/2015 19h20min25s BRT
UPDATE AD_Field SET DisplayLogic='@DocStatus@=CO | @DocStatus@=VO',Updated=TO_DATE('2015-05-14 19:20:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125373
;

-- 14/05/2015 19h20min28s BRT
UPDATE AD_Field SET DisplayLogic='@DocStatus@=CO | @DocStatus@=VO',Updated=TO_DATE('2015-05-14 19:20:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125370
;
