...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column_Trl SET Name='Origem do Produto',Updated=TO_DATE('2013-07-09 12:30:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=59231 AND AD_Language='pt_BR'
;

-- 09/07/2013 12h33min57s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_TaxDefinition ADD lbr_ProductSource CHAR(1) DEFAULT '0'
;

-- 09/07/2013 12h35min17s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,59231,58883,0,1106002,TO_DATE('2013-07-09 12:35:17','YYYY-MM-DD HH24:MI:SS'),0,'Defines the Product Source',1,'LBRA','Defines the Product Source','Y','Y','Y','N','N','N','N','N','Product Source',TO_DATE('2013-07-09 12:35:17','YYYY-MM-DD HH24:MI:SS'),0)
;
