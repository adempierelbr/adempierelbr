...
INSERT INTO AD_Form (AD_Client_ID,AD_Form_ID,AD_Org_ID,AccessLevel,Classname,Created,CreatedBy,EntityType,IsActive,IsBetaFunctionality,Name,Updated,UpdatedBy) VALUES (0,1000005,0,'3','org.adempierelbr.form.FormOutrasNF',TO_DATE('2008-07-23 21:22:18','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','N','Outras Notas Fiscais',TO_DATE('2008-07-23 21:22:18','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- 23/07/2008 21h22min18s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Form_Access (AD_Client_ID,AD_Form_ID,AD_Org_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,1000005,0,0,TO_DATE('2008-07-23 21:22:18','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2008-07-23 21:22:18','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 23/07/2008 21h23min8s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Menu (AD_Client_ID,AD_Form_ID,AD_Menu_ID,AD_Org_ID,Action,Created,CreatedBy,EntityType,IsActive,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES (0,1000005,1000033,0,'X',TO_DATE('2008-07-23 21:23:08','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','N','N','N','Outras Notas Fiscais',TO_DATE('2008-07-23 21:23:08','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- 23/07/2008 21h23min8s BRT
-- Default comment for updating dictionary
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID,0, 'Y', SysDate, 0, SysDate, 0,t.AD_Tree_ID, 1000033, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1000033)
;
...
-- 23/07/2008 21h23min14s BRT
-- Default comment for updating dictionary
UPDATE AD_TreeNodeMM SET Parent_ID=1000023, SeqNo=0, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1000033
;
...
-- 23/07/2008 21h23min14s BRT
-- Default comment for updating dictionary
UPDATE AD_TreeNodeMM SET Parent_ID=1000023, SeqNo=3, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1000024
;

-- 23/07/2008 21h23min14s BRT
-- Default comment for updating dictionary
UPDATE AD_TreeNodeMM SET Parent_ID=1000023, SeqNo=4, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1000025
;
...
-- 23/07/2008 21h23min14s BRT
-- Default comment for updating dictionary
UPDATE AD_TreeNodeMM SET Parent_ID=1000023, SeqNo=6, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1000022
;

-- 23/07/2008 21h23min14s BRT
-- Default comment for updating dictionary
UPDATE AD_TreeNodeMM SET Parent_ID=1000023, SeqNo=7, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1000027
;
...
-- 23/07/2008 21h23min19s BRT
-- Default comment for updating dictionary
UPDATE AD_TreeNodeMM SET Parent_ID=1000023, SeqNo=2, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1000033
;
