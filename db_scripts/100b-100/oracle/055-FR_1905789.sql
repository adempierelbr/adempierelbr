...
INSERT INTO AD_Element (AD_Org_ID,AD_Element_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,AD_Client_ID,UpdatedBy) VALUES (0,1000285,'ProcCreatePO',TO_DATE('2008-03-02 15:23:52','YYYY-MM-DD HH24:MI:SS'),100,'Process to Create PO Lines from Requisition','LBRA','Process to Create PO Lines from Requisition','Y','Create PO','Create PO',TO_DATE('2008-03-02 15:23:52','YYYY-MM-DD HH24:MI:SS'),0,100)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Process (AD_Org_ID,AD_Process_ID,AccessLevel,Classname,Created,CreatedBy,EntityType,IsActive,IsBetaFunctionality,IsDirectPrint,IsReport,IsServerProcess,Name,ShowHelp,Statistic_Count,Statistic_Seconds,Updated,UpdatedBy,Value,AD_Client_ID) VALUES (0,1000007,'3','org.adempierelbr.process.ProcCreatePO',TO_DATE('2008-03-02 15:26:10','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','N','N','N','N','ProcCreatePO','Y',0,0,TO_DATE('2008-03-02 15:26:10','YYYY-MM-DD HH24:MI:SS'),100,'ProcCreatePO',0)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Process_Access (AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,AD_Client_ID,UpdatedBy) VALUES (0,1000007,0,TO_DATE('2008-03-02 15:26:13','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2008-03-02 15:26:13','YYYY-MM-DD HH24:MI:SS'),0,100)
;

-- 02/03/2008 15h26min13s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Process_Access (AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,AD_Client_ID,UpdatedBy) VALUES (0,1000007,102,TO_DATE('2008-03-02 15:26:13','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2008-03-02 15:26:13','YYYY-MM-DD HH24:MI:SS'),0,100)
;

-- 02/03/2008 15h26min13s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Process_Access (AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,AD_Client_ID,UpdatedBy) VALUES (0,1000007,103,TO_DATE('2008-03-02 15:26:13','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2008-03-02 15:26:13','YYYY-MM-DD HH24:MI:SS'),0,100)
;

-- 02/03/2008 15h26min13s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Process_Access (AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,AD_Client_ID,UpdatedBy) VALUES (0,1000007,50001,TO_DATE('2008-03-02 15:26:13','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2008-03-02 15:26:13','YYYY-MM-DD HH24:MI:SS'),0,100)
;

-- 02/03/2008 15h27min12s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Process_Para (AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy,AD_Client_ID,AD_Element_ID) VALUES (0,1000007,1000012,30,'M_Requisition_ID',TO_DATE('2008-03-02 15:27:11','YYYY-MM-DD HH24:MI:SS'),100,'U',22,'Y','Y','Y','N','M_Requisition_ID',10,TO_DATE('2008-03-02 15:27:11','YYYY-MM-DD HH24:MI:SS'),100,0,2452)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Org_ID,AD_Element_ID,AD_Process_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,AD_Client_ID,Version,AD_Column_ID) VALUES (0,1000285,1000007,28,259,'ProcCreatePO',TO_DATE('2008-03-02 15:28:13','YYYY-MM-DD HH24:MI:SS'),100,NULL,'Process to Create PO Lines from Requisition','LBRA',1,'Process to Create PO Lines from Requisition','Y','N','N','N','N','N','N','N','N','N','Y','Create PO',0,TO_DATE('2008-03-02 15:28:13','YYYY-MM-DD HH24:MI:SS'),100,0,0,1000729)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (52064,0,294,TO_DATE('2008-03-02 15:28:52','YYYY-MM-DD HH24:MI:SS'),100,22,'D','Y','Y','Y','N','N','N','N','N','AmountTendered',TO_DATE('2008-03-02 15:28:52','YYYY-MM-DD HH24:MI:SS'),0,100,1000649)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000729,0,294,TO_DATE('2008-03-02 15:28:54','YYYY-MM-DD HH24:MI:SS'),100,'Process to Create PO Lines from Requisition',1,'LBRA','Process to Create PO Lines from Requisition','Y','Y','Y','N','N','N','N','N','Create PO',TO_DATE('2008-03-02 15:28:54','YYYY-MM-DD HH24:MI:SS'),0,100,1000650)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000593,0,294,TO_DATE('2008-03-02 15:28:55','YYYY-MM-DD HH24:MI:SS'),100,'Description Printed on Nota Fiscal',255,'LBRA','Description Printed on Nota Fiscal','Y','Y','Y','N','N','N','N','N','Nota Fiscal Description',TO_DATE('2008-03-02 15:28:55','YYYY-MM-DD HH24:MI:SS'),0,100,1000651)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (52063,0,294,TO_DATE('2008-03-02 15:28:57','YYYY-MM-DD HH24:MI:SS'),100,510,'D','Y','Y','Y','N','N','N','N','N','OrderType',TO_DATE('2008-03-02 15:28:57','YYYY-MM-DD HH24:MI:SS'),0,100,1000652)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (52070,0,294,TO_DATE('2008-03-02 15:28:59','YYYY-MM-DD HH24:MI:SS'),100,'Point of Sales Terminal',10,'D','The POS Terminal defines the defaults and functions available for the POS Form','Y','Y','Y','N','N','N','N','N','POS Terminal',TO_DATE('2008-03-02 15:28:59','YYYY-MM-DD HH24:MI:SS'),0,100,1000653)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (15899,0,294,TO_DATE('2008-03-02 15:29:01','YYYY-MM-DD HH24:MI:SS'),100,'Volume of a product',22,'D','The Volume indicates the volume of the product in the Volume UOM of the Client','Y','Y','Y','N','N','N','N','N','Volume',TO_DATE('2008-03-02 15:29:01','YYYY-MM-DD HH24:MI:SS'),0,100,1000654)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (15900,0,294,TO_DATE('2008-03-02 15:29:03','YYYY-MM-DD HH24:MI:SS'),100,'Weight of a product',22,'D','The Weight indicates the weight  of the product in the Weight UOM of the Client','Y','Y','Y','N','N','N','N','N','Weight',TO_DATE('2008-03-02 15:29:03','YYYY-MM-DD HH24:MI:SS'),0,100,1000655)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000672,0,294,TO_DATE('2008-03-02 15:29:04','YYYY-MM-DD HH24:MI:SS'),100,'Defines the Withhold Order',22,'LBRA','Defines the Withhold Order','Y','Y','Y','N','N','N','N','N','Withhold Order',TO_DATE('2008-03-02 15:29:04','YYYY-MM-DD HH24:MI:SS'),0,100,1000656)
;
