...
INSERT INTO AD_Element (AD_Org_ID,AD_Element_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,AD_Client_ID,UpdatedBy) VALUES (0,1000286,'lbr_BPShipperLicensePlate',TO_DATE('2008-03-03 15:43:50','YYYY-MM-DD HH24:MI:SS'),100,'Defines the BP Shipper License Plate','LBRA','Defines the BP Shipper License Plate','Y','BP Shipper License Plate','BP Shipper License Plate',TO_DATE('2008-03-03 15:43:50','YYYY-MM-DD HH24:MI:SS'),0,100)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_NotaFiscal ADD lbr_BPShipperLicensePlate NVARCHAR2(8)
;

-- 03/03/2008 15h49min6s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Element (AD_Org_ID,AD_Element_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,AD_Client_ID,UpdatedBy) VALUES (0,1000287,'lbr_PackingType',TO_DATE('2008-03-03 15:49:05','YYYY-MM-DD HH24:MI:SS'),100,'Defines the Packing Type','LBRA','Defines the Packing Type','Y','Packing Type','Packing Type',TO_DATE('2008-03-03 15:49:05','YYYY-MM-DD HH24:MI:SS'),0,100)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Org_ID,AD_Element_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,AD_Client_ID,Version,AD_Column_ID) VALUES (0,1000287,10,1000027,'lbr_PackingType',TO_DATE('2008-03-03 15:50:19','YYYY-MM-DD HH24:MI:SS'),100,'Defines the Packing Type','LBRA',60,'Defines the Packing Type','Y','N','N','N','N','N','N','N','N','N','Y','Packing Type',0,TO_DATE('2008-03-03 15:50:19','YYYY-MM-DD HH24:MI:SS'),100,0,0,1000731)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000731,0,1000028,TO_DATE('2008-03-03 15:51:06','YYYY-MM-DD HH24:MI:SS'),100,'Defines the Packing Type',60,'LBRA','Defines the Packing Type','Y','Y','Y','N','N','N','N','N','Packing Type',TO_DATE('2008-03-03 15:51:06','YYYY-MM-DD HH24:MI:SS'),0,100,1000658)
;
...
-- Default comment for updating dictionary
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2008-03-03 15:52:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000658
;

-- 03/03/2008 15h52min41s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000730,0,1000020,TO_DATE('2008-03-03 15:52:40','YYYY-MM-DD HH24:MI:SS'),100,'Defines the BP Shipper License Plate',8,'LBRA','Defines the BP Shipper License Plate','Y','Y','Y','N','N','N','N','N','BP Shipper License Plate',TO_DATE('2008-03-03 15:52:40','YYYY-MM-DD HH24:MI:SS'),0,100,1000659)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000731,0,1000020,TO_DATE('2008-03-03 15:52:41','YYYY-MM-DD HH24:MI:SS'),100,'Defines the Packing Type',60,'LBRA','Defines the Packing Type','Y','Y','Y','N','N','N','N','N','Packing Type',TO_DATE('2008-03-03 15:52:41','YYYY-MM-DD HH24:MI:SS'),0,100,1000660)
;
...
-- Default comment for updating dictionary
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2008-03-03 15:53:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000660
;

-- 03/03/2008 15h53min19s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET AD_FieldGroup_ID=130,Updated=TO_DATE('2008-03-03 15:53:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000659
;

-- 03/03/2008 15h53min23s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET AD_FieldGroup_ID=130,Updated=TO_DATE('2008-03-03 15:53:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000660
;

-- 03/03/2008 15h53min42s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET AD_FieldGroup_ID=130,Updated=TO_DATE('2008-03-03 15:53:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000657
;

-- 03/03/2008 15h53min47s BRT
-- Default comment for updating dictionary
UPDATE AD_Field SET AD_FieldGroup_ID=130,Updated=TO_DATE('2008-03-03 15:53:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000658
;
