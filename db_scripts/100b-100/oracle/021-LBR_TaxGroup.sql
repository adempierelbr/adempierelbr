...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxGroup ADD AD_Client_ID NUMERIC(10) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxGroup ADD AD_Org_ID NUMERIC(10) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxGroup ADD CreatedBy NUMERIC(10) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxGroup ADD UpdatedBy NUMERIC(10) NOT NULL
;
...
-- 11/02/2008 14h2min18s BRST
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxGroup ADD Description nvarchar2(255)
;
...
-- Default comment for updating dictionary
ALTER TABLE C_Tax ADD LBR_TaxGroup_ID NUMERIC(10)
;
