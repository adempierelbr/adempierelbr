...
INSERT INTO AD_Column (AD_Org_ID,AD_Element_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,AD_Client_ID,Version,AD_Column_ID) VALUES (0,1000127,12,1000035,'lbr_TaxRate',TO_DATE('2008-02-27 08:21:07','YYYY-MM-DD HH24:MI:SS'),100,'Indicates the Tax Rate','LBRA',22,'Indicates the Tax Rate','Y','N','N','N','N','N','N','N','N','N','Y','Tax Rate',0,TO_DATE('2008-02-27 08:21:07','YYYY-MM-DD HH24:MI:SS'),100,0,0,1000709)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_NFLineTax ADD lbr_TaxRate NUMBER
;

-- 27/02/2008 8h21min37s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Org_ID,AD_Element_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,AD_Client_ID,Version,AD_Column_ID) VALUES (0,1000128,12,1000035,'lbr_TaxBase',TO_DATE('2008-02-27 08:21:36','YYYY-MM-DD HH24:MI:SS'),100,'Indicates the Tax Base','LBRA',22,'Indicates the Tax Base','Y','N','N','N','N','N','N','N','N','N','Y','Tax Base',0,TO_DATE('2008-02-27 08:21:36','YYYY-MM-DD HH24:MI:SS'),100,0,0,1000710)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000709,0,1000031,TO_DATE('2008-02-27 08:22:18','YYYY-MM-DD HH24:MI:SS'),100,'Indicates the Tax Rate',22,'LBRA','Indicates the Tax Rate','Y','Y','Y','N','N','N','N','N','Tax Rate',TO_DATE('2008-02-27 08:22:18','YYYY-MM-DD HH24:MI:SS'),0,100,1000629)
;
...
-- Default comment for updating dictionary
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2008-02-27 08:22:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000628
;

-- 27/02/2008 8h22min47s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000710,0,1000027,TO_DATE('2008-02-27 08:22:46','YYYY-MM-DD HH24:MI:SS'),100,'Indicates the Tax Base',22,'LBRA','Indicates the Tax Base','Y','Y','Y','N','N','N','N','N','Tax Base',TO_DATE('2008-02-27 08:22:46','YYYY-MM-DD HH24:MI:SS'),0,100,1000630)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Column_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,AD_Client_ID,UpdatedBy,AD_Field_ID) VALUES (1000709,0,1000027,TO_DATE('2008-02-27 08:22:47','YYYY-MM-DD HH24:MI:SS'),100,'Indicates the Tax Rate',22,'LBRA','Indicates the Tax Rate','Y','Y','Y','N','N','N','N','N','Tax Rate',TO_DATE('2008-02-27 08:22:47','YYYY-MM-DD HH24:MI:SS'),0,100,1000631)
;
