...
public class NFSeRPSGenerator
{
	...
	{
		Timestamp ts = POLBR.stringTodate(data, "yyyy-MM-dd'T'HH:mm:ss");
	...
	public static void main(String[] args) 
	{
		...
		{
			System.out.print(
			generateHeader("4.057.791-0", POLBR.stringTodate("07062010", "ddMMyyyy"), Env.getContextAsDate(Env.getCtx(), "#Date"))
			);
