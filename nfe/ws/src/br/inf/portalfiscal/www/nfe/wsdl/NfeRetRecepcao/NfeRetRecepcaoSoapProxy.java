...
public class NfeRetRecepcaoSoapProxy implements br.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap {
  private String _endpoint = null;
  private br.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap nfeRetRecepcaoSoap = null;
  ...
  private void _initNfeRetRecepcaoSoapProxy() {
    try {
      nfeRetRecepcaoSoap = (new br.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoLocator()).getNfeRetRecepcaoSoap();
  ...
  public br.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap getNfeRetRecepcaoSoap() {
    if (nfeRetRecepcaoSoap == null)
      _initNfeRetRecepcaoSoapProxy();
