...
public class NfeInutilizacaoLocator extends org.apache.axis.client.Service implements br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacao {
 ...
 */
    ...
    private java.lang.String NfeInutilizacaoSoap12_address = ambiente.equals(PRODUCAO) 			?
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoap getNfeInutilizacaoSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoap12Stub(portAddress, this);
    ...
    private java.lang.String NfeInutilizacaoSoap_address = ambiente.equals(PRODUCAO) 			?
    		"https://nfe.fazenda.sp.gov.br/nfeWEB/services/NfeInutilizacao.asmx"				:
        	"https://homologacao.nfe.fazenda.sp.gov.br/nfeWEB/services/NfeInutilizacao.asmx"	;
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoap getNfeInutilizacaoSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoapStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoap12Stub(new java.net.URL(NfeInutilizacaoSoap12_address), this);
                _stub.setPortName(getNfeInutilizacaoSoap12WSDDServiceName());
                return _stub;
            }
            if (br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoapStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoapStub(new java.net.URL(NfeInutilizacaoSoap_address), this);
                _stub.setPortName(getNfeInutilizacaoSoapWSDDServiceName());
                return _stub;
            }
        }
