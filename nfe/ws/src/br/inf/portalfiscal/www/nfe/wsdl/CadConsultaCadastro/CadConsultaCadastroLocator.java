...
public class CadConsultaCadastroLocator extends org.apache.axis.client.Service implements br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastro {
 ...
 */
    ...
    private java.lang.String CadConsultaCadastroSoap12_address = ambiente.equals(PRODUCAO) 			?
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap getCadConsultaCadastroSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap getCadConsultaCadastroSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap12Stub(portAddress, this);
    ...
    private java.lang.String CadConsultaCadastroSoap_address = ambiente.equals(PRODUCAO) 			?
    		"https://nfe.fazenda.sp.gov.br/nfeWEB/services/cadconsultacadastro.asmx"				:
        	"https://homologacao.nfe.fazenda.sp.gov.br/nfeWEB/services/cadconsultacadastro.asmx"	;
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap getCadConsultaCadastroSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap getCadConsultaCadastroSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoapStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap12Stub(new java.net.URL(CadConsultaCadastroSoap12_address), this);
                _stub.setPortName(getCadConsultaCadastroSoap12WSDDServiceName());
                return _stub;
            }
            if (br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoapStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoapStub(new java.net.URL(CadConsultaCadastroSoap_address), this);
                _stub.setPortName(getCadConsultaCadastroSoapWSDDServiceName());
                return _stub;
            }
        }
