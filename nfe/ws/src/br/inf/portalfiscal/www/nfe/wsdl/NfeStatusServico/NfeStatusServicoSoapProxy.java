...
public class NfeStatusServicoSoapProxy implements br.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap {
  private String _endpoint = null;
  private br.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap nfeStatusServicoSoap = null;
  ...
  private void _initNfeStatusServicoSoapProxy() {
    try {
      nfeStatusServicoSoap = (new br.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoLocator()).getNfeStatusServicoSoap();
  ...
  public br.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap getNfeStatusServicoSoap() {
    if (nfeStatusServicoSoap == null)
      _initNfeStatusServicoSoapProxy();
