...
public class CadConsultaCadastroSoapProxy implements br.sp.h.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap {
  private String _endpoint = null;
  private br.sp.h.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap cadConsultaCadastroSoap = null;
  ...
  private void _initCadConsultaCadastroSoapProxy() {
    try {
      cadConsultaCadastroSoap = (new br.sp.h.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroLocator()).getCadConsultaCadastroSoap();
  ...
  public br.sp.h.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap getCadConsultaCadastroSoap() {
    if (cadConsultaCadastroSoap == null)
      _initCadConsultaCadastroSoapProxy();
