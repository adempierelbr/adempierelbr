...
public class NfeRecepcaoSoapProxy implements br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeRecepcao.NfeRecepcaoSoap {
  private String _endpoint = null;
  private br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeRecepcao.NfeRecepcaoSoap nfeRecepcaoSoap = null;
  ...
  private void _initNfeRecepcaoSoapProxy() {
    try {
      nfeRecepcaoSoap = (new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeRecepcao.NfeRecepcaoLocator()).getNfeRecepcaoSoap();
  ...
  public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeRecepcao.NfeRecepcaoSoap getNfeRecepcaoSoap() {
    if (nfeRecepcaoSoap == null)
      _initNfeRecepcaoSoapProxy();
