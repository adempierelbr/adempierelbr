...
public class NfeConsultaSoapProxy implements br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap {
  private String _endpoint = null;
  private br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap nfeConsultaSoap = null;
  ...
  private void _initNfeConsultaSoapProxy() {
    try {
      nfeConsultaSoap = (new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaLocator()).getNfeConsultaSoap();
  ...
  public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap getNfeConsultaSoap() {
    if (nfeConsultaSoap == null)
      _initNfeConsultaSoapProxy();
