...
public class NfeInutilizacaoSoapProxy implements br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoap {
  private String _endpoint = null;
  private br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoap nfeInutilizacaoSoap = null;
  ...
  private void _initNfeInutilizacaoSoapProxy() {
    try {
      nfeInutilizacaoSoap = (new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoLocator()).getNfeInutilizacaoSoap();
  ...
  public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeInutilizacao.NfeInutilizacaoSoap getNfeInutilizacaoSoap() {
    if (nfeInutilizacaoSoap == null)
      _initNfeInutilizacaoSoapProxy();
