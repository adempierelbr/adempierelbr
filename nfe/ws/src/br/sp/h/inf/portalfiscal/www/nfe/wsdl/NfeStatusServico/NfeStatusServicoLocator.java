...
public class NfeStatusServicoLocator extends org.apache.axis.client.Service implements br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServico {
 ...
 */
    ...
    private java.lang.String NfeStatusServicoSoap12_address = "https://homologacao.nfe.fazenda.sp.gov.br/nfeWEB/services/NfeStatusServico.asmx";
    ...
    public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap getNfeStatusServicoSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap getNfeStatusServicoSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap12Stub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap12Stub(portAddress, this);
    ...
    public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap getNfeStatusServicoSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap getNfeStatusServicoSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoapStub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap12Stub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap12Stub(new java.net.URL(NfeStatusServicoSoap12_address), this);
                _stub.setPortName(getNfeStatusServicoSoap12WSDDServiceName());
                return _stub;
            }
            if (br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoapStub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoapStub(new java.net.URL(NfeStatusServicoSoap_address), this);
                _stub.setPortName(getNfeStatusServicoSoapWSDDServiceName());
                return _stub;
            }
        }
