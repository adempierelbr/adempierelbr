...
public class NfeCancelamentoLocator extends org.apache.axis.client.Service implements br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamento {
 ...
 */
    ...
    public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap getNfeCancelamentoSoap() throws javax.xml.rpc.ServiceException {
    ...
    public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap getNfeCancelamentoSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoapStub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoapStub(portAddress, this);
    ...
    private java.lang.String NfeCancelamentoSoap12_address = "https://homologacao.nfe.fazenda.sp.gov.br/nfeWEB/services/NfeCancelamento.asmx";
    ...
    public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap getNfeCancelamentoSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap getNfeCancelamentoSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap12Stub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoapStub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoapStub(new java.net.URL(NfeCancelamentoSoap_address), this);
                _stub.setPortName(getNfeCancelamentoSoapWSDDServiceName());
                return _stub;
            }
            if (br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap12Stub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap12Stub(new java.net.URL(NfeCancelamentoSoap12_address), this);
                _stub.setPortName(getNfeCancelamentoSoap12WSDDServiceName());
                return _stub;
            }
        }
