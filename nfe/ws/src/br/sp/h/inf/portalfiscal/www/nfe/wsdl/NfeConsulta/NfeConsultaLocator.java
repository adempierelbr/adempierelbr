...
public class NfeConsultaLocator extends org.apache.axis.client.Service implements br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsulta {
 ...
 */
    ...
    public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap getNfeConsultaSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoapStub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoapStub(portAddress, this);
    ...
    private java.lang.String NfeConsultaSoap12_address = "https://homologacao.nfe.fazenda.sp.gov.br/nfeWEB/services/NfeConsulta.asmx";
    ...
    public br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap getNfeConsultaSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap12Stub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoapStub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoapStub(new java.net.URL(NfeConsultaSoap_address), this);
                _stub.setPortName(getNfeConsultaSoapWSDDServiceName());
                return _stub;
            }
            if (br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap12Stub _stub = new br.sp.h.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap12Stub(new java.net.URL(NfeConsultaSoap12_address), this);
                _stub.setPortName(getNfeConsultaSoap12WSDDServiceName());
                return _stub;
            }
        }
