...
public class NfeStatusServicoLocator extends org.apache.axis.client.Service implements br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServico {
 ...
 */
    ...
    private java.lang.String NfeStatusServicoSoap12_address = "https://nfe.fazenda.sp.gov.br/nfeWEB/services/NfeStatusServico.asmx";
    ...
    public br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap getNfeStatusServicoSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap12Stub _stub = new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap12Stub(portAddress, this);
    ...
    private java.lang.String NfeStatusServicoSoap_address = "https://nfe.fazenda.sp.gov.br/nfeWEB/services/NfeStatusServico.asmx";
    ...
    public br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap getNfeStatusServicoSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoapStub _stub = new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap12Stub _stub = new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap12Stub(new java.net.URL(NfeStatusServicoSoap12_address), this);
                _stub.setPortName(getNfeStatusServicoSoap12WSDDServiceName());
                return _stub;
            }
            if (br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoapStub _stub = new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoapStub(new java.net.URL(NfeStatusServicoSoap_address), this);
                _stub.setPortName(getNfeStatusServicoSoapWSDDServiceName());
                return _stub;
            }
        }
