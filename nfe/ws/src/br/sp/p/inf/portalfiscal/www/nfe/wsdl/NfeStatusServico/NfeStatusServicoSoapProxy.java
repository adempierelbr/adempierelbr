...
public class NfeStatusServicoSoapProxy implements br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap {
  private String _endpoint = null;
  private br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap nfeStatusServicoSoap = null;
  ...
  private void _initNfeStatusServicoSoapProxy() {
    try {
      nfeStatusServicoSoap = (new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoLocator()).getNfeStatusServicoSoap();
  ...
  public br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeStatusServico.NfeStatusServicoSoap getNfeStatusServicoSoap() {
    if (nfeStatusServicoSoap == null)
      _initNfeStatusServicoSoapProxy();
