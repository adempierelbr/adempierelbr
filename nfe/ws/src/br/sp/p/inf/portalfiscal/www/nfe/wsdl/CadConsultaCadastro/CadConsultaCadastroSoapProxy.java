...
public class CadConsultaCadastroSoapProxy implements br.sp.p.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap {
  private String _endpoint = null;
  private br.sp.p.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap cadConsultaCadastroSoap = null;
  ...
  private void _initCadConsultaCadastroSoapProxy() {
    try {
      cadConsultaCadastroSoap = (new br.sp.p.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroLocator()).getCadConsultaCadastroSoap();
  ...
  public br.sp.p.inf.portalfiscal.www.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastroSoap getCadConsultaCadastroSoap() {
    if (cadConsultaCadastroSoap == null)
      _initCadConsultaCadastroSoapProxy();
