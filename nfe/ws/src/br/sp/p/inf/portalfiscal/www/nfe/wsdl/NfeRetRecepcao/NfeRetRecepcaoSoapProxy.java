...
public class NfeRetRecepcaoSoapProxy implements br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap {
  private String _endpoint = null;
  private br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap nfeRetRecepcaoSoap = null;
  ...
  private void _initNfeRetRecepcaoSoapProxy() {
    try {
      nfeRetRecepcaoSoap = (new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoLocator()).getNfeRetRecepcaoSoap();
  ...
  public br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap getNfeRetRecepcaoSoap() {
    if (nfeRetRecepcaoSoap == null)
      _initNfeRetRecepcaoSoapProxy();
