...
public class NfeConsultaSoapProxy implements br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap {
  private String _endpoint = null;
  private br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap nfeConsultaSoap = null;
  ...
  private void _initNfeConsultaSoapProxy() {
    try {
      nfeConsultaSoap = (new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaLocator()).getNfeConsultaSoap();
  ...
  public br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeConsulta.NfeConsultaSoap getNfeConsultaSoap() {
    if (nfeConsultaSoap == null)
      _initNfeConsultaSoapProxy();
