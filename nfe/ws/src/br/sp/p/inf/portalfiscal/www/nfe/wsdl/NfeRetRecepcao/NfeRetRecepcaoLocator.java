...
package br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao;

public class NfeRetRecepcaoLocator extends org.apache.axis.client.Service implements br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcao {
 ...
 */
    ...
    private java.lang.String NfeRetRecepcaoSoap_address = "https://nfe.fazenda.sp.gov.br/nfeWEB/services/NfeRetRecepcao.asmx";
    ...
    public br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap getNfeRetRecepcaoSoap() throws javax.xml.rpc.ServiceException {
    ...
    public br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap getNfeRetRecepcaoSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoapStub _stub = new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoapStub(portAddress, this);
    ...
    private java.lang.String NfeRetRecepcaoSoap12_address = "https://nfe.fazenda.sp.gov.br/nfeWEB/services/NfeRetRecepcao.asmx";
    ...
    public br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap getNfeRetRecepcaoSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap getNfeRetRecepcaoSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap12Stub _stub = new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoapStub _stub = new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoapStub(new java.net.URL(NfeRetRecepcaoSoap_address), this);
                _stub.setPortName(getNfeRetRecepcaoSoapWSDDServiceName());
                return _stub;
            }
            if (br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap12Stub _stub = new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeRetRecepcao.NfeRetRecepcaoSoap12Stub(new java.net.URL(NfeRetRecepcaoSoap12_address), this);
                _stub.setPortName(getNfeRetRecepcaoSoap12WSDDServiceName());
                return _stub;
            }
        }
