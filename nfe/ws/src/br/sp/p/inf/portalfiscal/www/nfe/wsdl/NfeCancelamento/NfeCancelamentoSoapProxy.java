...
public class NfeCancelamentoSoapProxy implements br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap {
  private String _endpoint = null;
  private br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap nfeCancelamentoSoap = null;
  ...
  private void _initNfeCancelamentoSoapProxy() {
    try {
      nfeCancelamentoSoap = (new br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoLocator()).getNfeCancelamentoSoap();
  ...
  public br.sp.p.inf.portalfiscal.www.nfe.wsdl.NfeCancelamento.NfeCancelamentoSoap getNfeCancelamentoSoap() {
    if (nfeCancelamentoSoap == null)
      _initNfeCancelamentoSoapProxy();
