/**
 * CadConsultaCadastro2Stub.java This file was auto-generated from WSDL by the
...
public class CadConsultaCadastro2Stub extends org.apache.axis2.client.Stub
{
	...
	public br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.ConsultaCadastro2Response consultaCadastro2(
			...
			br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.ConsultaCadastro2 consultaCadastro20,
			br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.NfeCabecMsgE nfeCabecMsg1)
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback()
				{
							...
							org.apache.axis2.context.MessageContext resultContext)
					{
						try
						{
							...
							callback.receiveResultconsultaCadastro2((br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.ConsultaCadastro2Response) object);
	...
	public static class NfeCabecMsg implements org.apache.axis2.databinding.ADBBean
	{
		...
		{
			if (namespace
					.equals("http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro2"))
			{
				return "ns1";
			}
	...
	public static class ConsultaCadastro2 implements
					...
					throws java.lang.Exception
			{
				...
				try
				{
						...
						if (fullTypeName != null)
						{
							...
							if (!"consultaCadastro2".equals(type))
							{
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (ConsultaCadastro2) ExtensionMapper
									...
									"nfeDadosMsg").equals(reader.getName()))
					{
						...
						object.setNfeDadosMsg(NfeDadosMsg_type0.Factory
								.parse(reader));
	...
	public static class ExtensionMapper
	{
				...
				throws java.lang.Exception
		{
			...
			if ("http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro2"
	...
	public static class ConsultaCadastro2Result_type0 implements
			org.apache.axis2.databinding.ADBBean
	{
		/*
		 * This type was generated from the piece of schema that had name =
						...
						if (fullTypeName != null)
						{
							...
							if (!"consultaCadastro2Result_type0".equals(type))
							{
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (ConsultaCadastro2Result_type0) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
	...
	public static class ConsultaCadastro2Response implements
			org.apache.axis2.databinding.ADBBean
	{
					...
					throws java.lang.Exception
			{
				...
				try
				{
						...
						if (fullTypeName != null)
						{
							...
							if (!"consultaCadastro2Response".equals(type))
							{
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (ConsultaCadastro2Response) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
									...
									.getName()))
					{
						...
						object.setConsultaCadastro2Result(ConsultaCadastro2Result_type0.Factory
								.parse(reader));
	...
	public static class NfeDadosMsg_type0 implements
			org.apache.axis2.databinding.ADBBean
	{
		/*
		 * This type was generated from the piece of schema that had name =
						...
						if (fullTypeName != null)
						{
							...
							if (!"nfeDadosMsg_type0".equals(type))
							{
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (NfeDadosMsg_type0) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.ConsultaCadastro2 param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.ConsultaCadastro2.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.ConsultaCadastro2Response param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.ConsultaCadastro2Response.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		}
		catch (org.apache.axis2.databinding.ADBException e)
		{
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.NfeCabecMsgE param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.NfeCabecMsgE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		}
		catch (org.apache.axis2.databinding.ADBException e)
		{
			...
			throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			...
			if (br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.ConsultaCadastro2.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.ConsultaCadastro2.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.ConsultaCadastro2Response.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.ConsultaCadastro2Response.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.NfeCabecMsgE.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro2.CadConsultaCadastro2Stub.NfeCabecMsgE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
