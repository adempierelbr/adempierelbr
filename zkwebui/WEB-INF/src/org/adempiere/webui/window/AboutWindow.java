...
//		tabbox.setSclass("lite");
	...
	private Tabpanel createCredit() {
		...
		link.setImage(ThemeManager.getLargeLogo());
		link.setParent(hbox);
...
//		label.setParent(hbox);
		...
		div.setParent(vbox);
		div.setWidth("100%");
		Label caption = new Label("Patrocinadores da Localização Brasil");
		...
		link.setLabel("Kenos");
		link.setHref("http://www.kenos.com.br/");
		link.setTarget("_blank");
		link.setParent(content);
		link = new ToolBarButton();
		link.setLabel("Soliton");
		link.setHref("http://www.soliton.com.br/");
		link.setTarget("_blank");
		link.setParent(content);
		link = new ToolBarButton();
		...
		div.setParent(vbox);
		div.setWidth("100%");
		caption = new Label("Contribuidores Atuais");
		caption.setStyle("font-weight: bold;");
		div.appendChild(caption);
		separator = new Separator();
		separator.setBar(true);
		...
		content.setParent(div);
		link = new ToolBarButton();
		link.setLabel("Ricardo Santana");
		link.setHref("http://www.kenos.com.br/");
		link.setTarget("_blank");
		link.setParent(content);

		link = new ToolBarButton();
		link.setLabel("Rogério Feitosa");
		link.setHref("http://www.kenos.com.br/");
		link.setTarget("_blank");
		link.setParent(content);

		link = new ToolBarButton();
		link.setLabel("William Souza");
		link.setHref("http://www.kenos.com.br/");
		link.setTarget("_blank");
		link.setParent(content);
...
//		div.setParent(vbox);
//		div.setWidth("100%");
//		caption = new Label("Patrocinadores da Versão Web");
//		caption.setStyle("font-weight: bold;");
//		div.appendChild(caption);
//		separator = new Separator();
//		separator.setBar(true);
...
//		div.setParent(vbox);
//		div.setWidth("100%");
//		caption = new Label("Contribuidores");
//		caption.setStyle("font-weight: bold;");
//		div.appendChild(caption);
//		separator = new Separator();
//		separator.setBar(true);
...
//		separator.setParent(vbox);
		ToolBarButton link = new ToolBarButton();
		link.setLabel("Projeto BitBucket");
		link.setHref("https://bitbucket.org/AdempiereLBR/adempierelbr");
		link.setTarget("_blank");
		link.setParent(vbox);
...
//		separator.setParent(vbox);
		link = new ToolBarButton();
		link.setLabel("ADempiereLBR");
		link.setHref("http://www.adempiere.com.br");
		link.setTarget("_blank");
		link.setParent(vbox);
...
//		separator.setParent(vbox);
		link = new ToolBarButton();
		link.setLabel("ADempiere");
		link.setHref("http://www.adempiere.io");
		link.setTarget("_blank");
		link.setParent(vbox);
		
		link = new ToolBarButton();
		link.setLabel("Suporte e Discussões");
		link.setHref("http://forum.kenos.com.br");
		link.setTarget("_blank");
		link.setParent(vbox);
