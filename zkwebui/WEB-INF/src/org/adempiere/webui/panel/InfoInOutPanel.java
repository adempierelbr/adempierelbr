...
public class InfoInOutPanel extends InfoPanel implements ValueChangeListener, EventListener
{
	...
	private static final ColumnInfo[] s_invoiceLayout = {
		...
		new ColumnInfo(Msg.translate(Env.getCtx(), "C_Order_ID"), "(SELECT DocumentNo FROM C_Order o WHERE o.C_Order_ID=i.C_Order_ID)", String.class),
	...
	private void statInit() throws Exception
	{
		...
		fOrder_ID = new WSearchEditor(
				...
				Msg.translate(Env.getCtx(), "Order"), "", false, false, true);
