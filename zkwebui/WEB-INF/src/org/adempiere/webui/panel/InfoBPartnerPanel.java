...
//	private Textbox fieldEMail;
	...
	private Textbox fieldCNPJ;
	private Label lblCPF;
	private Textbox fieldCPF;
...
//		lblEMail.setValue(Msg.getMsg(Env.getCtx(), "EMail"));
		lblCNPJ = new Label();
		lblCNPJ.setValue(Msg.translate(Env.getCtx(), "lbr_CNPJ"));
		lblCPF = new Label();
		lblCPF.setValue(Msg.getMsg(Env.getCtx(), "lbr_CPF"));
		lblPostal = new Label();
...
//		fieldEMail.setMaxlength(40);
		fieldCNPJ = new Textbox();
		fieldCNPJ.setMaxlength(40);
		fieldCPF = new Textbox();
		fieldCPF.setMaxlength(40);
...
//		row.appendChild(fieldContact);
		row.appendChild(lblCNPJ.rightAlign());
		row.appendChild(fieldCNPJ);
...
//		row.appendChild(fieldEMail);
		row.appendChild(lblCPF.rightAlign());
		row.appendChild(fieldCPF);
	...
	private void initInfo(String value, String whereClause)
	{
			...
			**/
			...
			list.add(new ColumnInfo(" ", "C_BPartner.C_BPartner_ID", IDColumn.class));
			list.add(new ColumnInfo(Msg.translate(Env.getCtx(), "Value"), "C_BPartner.Value", String.class));
			list.add(new ColumnInfo(Msg.translate(Env.getCtx(), "Name"), "C_BPartner.Name", String.class));
			list.add(new ColumnInfo("CNPJ/CPF/ID", "COALESCE (C_BPartner.lbr_CNPJ, C_BPartner.lbr_CPF, C_BPartner.TaxID)", String.class));
			if (windowAccess)
			{
				if (columnCreditAccess)
				{
					list.add(new ColumnInfo(Msg.translate(Env.getCtx(), "SO_CreditAvailable"), "C_BPartner.SO_CreditLimit-C_BPartner.SO_CreditUsed AS SO_CreditAvailable", BigDecimal.class, true, true, null));
					list.add(new ColumnInfo(Msg.translate(Env.getCtx(), "SO_CreditUsed"), "C_BPartner.SO_CreditUsed", BigDecimal.class));
				}
				
				if (columnOpenBalanceAccess)
					list.add(new ColumnInfo(Msg.translate(Env.getCtx(), "TotalOpenBalance"), "C_BPartner.TotalOpenBalance", BigDecimal.class));
			}
//			list.add(new ColumnInfo(Msg.translate(Env.getCtx(), "Phone"), "c.Phone", String.class));
			...
			list.add(new ColumnInfo(Msg.translate(Env.getCtx(), "City"), "a.City || NVL (' - ' || r.Name)", String.class));
			...
			list.add(new ColumnInfo(Msg.translate(Env.getCtx(), "IsBillTo"), "l.IsBillTo", Boolean.class));
			
			ColumnInfo[] s_partnerLayout = new ColumnInfo[list.size()];
