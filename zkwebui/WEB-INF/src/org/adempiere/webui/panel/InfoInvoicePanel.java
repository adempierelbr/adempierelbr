 ...
 * 
 * @author 	Rogério Feitosa <contato@kenos.com.br>
 * 			<li>LBR-15 Incluir Coluna Data de Vencimento no Formulário Informações da Fatura
 * 			<li>https://adempiere.atlassian.net/browse/LBR-15
 * 
 **/
public class InfoInvoicePanel extends InfoPanel implements ValueChangeListener
{
    ...
    *
    ...
    private static final ColumnInfo[] s_invoiceLayout = {
        ...
        new Info_Column(Msg.translate(Env.getCtx(), "LBR_NotaFiscal_ID"), "(SELECT max(documentno) FROM lbr_notafiscal nf WHERE nf.c_invoice_id=i.c_invoice_id)", String.class),
