...
public class FieldRecordInfo extends CDialog
{
	 ...
	 *  @param Record_ID
	 */
	public FieldRecordInfo (Frame owner, String title, String content, int AD_Table_ID, int AD_Column_ID, int Record_ID)
	{
	...
	public static void start(GridField mField) {
		...
		//
		String content = "";
		if (mField.getValue() instanceof Boolean)
		{
			content = (Boolean) mField.getValue() ? "Y" : "N";
		}
		else
			content = "" + mField.getValue();
		//
