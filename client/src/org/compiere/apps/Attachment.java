	...
	implements ActionListener
{
	...
	private JScrollPane center = new JScrollPane(xmlArea);
		...
		else
		{
			...
			{			
				try
				{
					...
					xml = XmlObject.Factory.parse(new String(entry.getData()),options);					
					xml.save(writer,options);
					xmlArea.setText(writer.toString());
				...
				{
					log.log(Level.SEVERE, "Could not create xml");
				}
			}
		}
