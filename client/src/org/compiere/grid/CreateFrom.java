...
public abstract class CreateFrom implements ICreateFrom
{
	 ...
	 */
	protected ArrayList<KeyNamePair> loadOrderData (int C_BPartner_ID, int AD_Org_ID, boolean forInvoice, boolean sameWarehouseOnly)
	{
		...
		StringBuffer sql = new StringBuffer("SELECT o.C_Order_ID,").append(display)
			...
			+ "WHERE o.C_BPartner_ID=? AND o.AD_Org_ID=? AND o.IsSOTrx='N' AND o.DocStatus IN ('CL','CO')"
			+ " AND o.C_Order_ID IN "
