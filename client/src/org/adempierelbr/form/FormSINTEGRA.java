 ...
 * @version $Id: FormSintegra.java,v 1.2 2009/04/08 00:51:28 ralexsander Exp $
 */
public class FormSINTEGRA extends CPanel
	implements FormPanel, ActionListener, TableModelListener, VetoableChangeListener
{
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(FormSINTEGRA.class);
