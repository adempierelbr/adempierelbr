...
import org.adempierelbr.model.I_W_C_BankStatementLoader;
...
public final class OFXFileBankStatementLoader extends OFXBankStatementHandler implements BankStatementLoaderInterface
{
	...
	public boolean init(MBankStatementLoader controller)
	{
		...
		try
		{
			...
			I_W_C_BankStatementLoader controllerW = POWrapper.create (controller, I_W_C_BankStatementLoader.class);
			result = attachInput (m_stream, controllerW.getLBR_Charset());
		}
		catch(Exception e)
		{
