...
public final class OFX1ToXML extends InputStream implements Runnable
{
	...
	/** Date Regex					*/
	private final String datePattern = "^\\s+\\<DT\\w+\\>"	//	Abertura da Tag de Data <DT*>
			+ "[1,2][0-9]{3}"								//	Ano 1999, 2016
			+ "(0[1-9]|1[0-2])"								//	Mes 01, 12
			+ "(0[1-9]|[1-2][0-9]|3[0-1])"					//	Dia 01, 12, 29, 31
			+ "[0-9]{6}"									//	Aceita qualquer Hora 123555 (12h 35m 55s)
			+ "(|\\[(-|)[0-9]{0,2}\\:\\w{0,3}\\])"			//	Timezone [-03:EST]
			+ "<\\/DT\\w+>";								//	Fechamento da Tag de Data </DT*>
	...
	private void write(String str) throws IOException
	{
		...
		if (str.matches(datePattern))
			str = str.replaceAll("[0-9]{6}(|\\[(-|)[0-9]{0,2}\\:\\w{0,3}\\])\\<\\/", "</");	//	Hour Pattern
		//
