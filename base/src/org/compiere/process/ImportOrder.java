		...
		**/
		...
		try
		{
			...
			while (rs.next ())
			{
				...
				//	LBR
				addTax (line, "PISPROD", imp.get_ValueAsString("LBR_CSTPIS"), (BigDecimal) imp.get_Value("LBR_PISRate"));
				addTax (line, "COFINSPROD", imp.get_ValueAsString("LBR_CSTCOFINS"), (BigDecimal) imp.get_Value("LBR_COFINSRate"));
				addTax (line, "ICMSPROD", imp.get_ValueAsString("LBR_CSTICMS"), (BigDecimal) imp.get_Value("LBR_ICMSRate"));
				addTax (line, "IPI", imp.get_ValueAsString("LBR_CSTIPI"), (BigDecimal) imp.get_Value("LBR_IPIRate"));
				addTax (line, "II", null, (BigDecimal) imp.get_Value("LBR_IIRate"));
				
				//	SISCOMEX
				setDI (line, imp.get_ValueAsString("lbr_DI"), imp.get_ValueAsString("LBR_ADI"));
				
				//	Additional charges
				line.set_CustomColumn("lbr_SISCOMEXAmt", imp.get_Value("lbr_SISCOMEXAmt"));
