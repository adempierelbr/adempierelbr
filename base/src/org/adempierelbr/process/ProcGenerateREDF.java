		...
		for (MLBRNotaFiscal NF : list)
		{
			...
			for (MLBRNotaFiscalLine line : NF.getLines("Line"))
			{
				Registro30 r30 = new Registro30 (line.getProductValue(), line.getProductName(), 
						line.getlbr_NCMName(), line.getlbr_UOMName(), line.getQty(), line.getPrice().add(line.getICMSAmt().divide(line.getQty(), 14, BigDecimal.ROUND_HALF_UP)), 
			...
			Registro40 r40 = new Registro40 (NF.getICMSBase(), NF.getICMSAmt(), NF.getICMSBaseST(), 
					NF.getICMSAmtST(), NF.getTotalLines().add(NF.getICMSAmt()), NF.getFreightAmt(), NF.getlbr_InsuranceAmt(),
